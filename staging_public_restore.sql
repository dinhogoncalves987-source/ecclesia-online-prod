...
BEGIN
  ...
  END IF;
  -- ValidaÃ§Ã£o de e-mail: impede que admin aceite convite no lugar do convidado real
  ...
  SELECT EXISTS (
    ...
    WHERE  t.id = _thread_id
      AND  (
        ...
        OR (
          -- Campanha: qualquer membro da organizaÃ§Ã£o pode ler
          t.source = 'campaign'
  ...
  SELECT EXISTS (
    ...
    WHERE  t.id = _thread_id
      AND  (
        ...
        OR (
          -- Outros contextos (nÃ£o campanha): dono da thread
          t.source <> 'campaign'
          AND t.reply_enabled = true
          AND t.status IN ('open', 'pending', 'answered')
...
CREATE FUNCTION public.is_valid_organization_hierarchy(_parent_type text, _child_type text) RETURNS boolean
  ...
  SELECT CASE
    ...
    -- â”€â”€ Internacional â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    -- OrganizaÃ§Ãµes internacionais podem criar qualquer nÃ­vel abaixo.
    -- Suporta: RestauraÃ§Ã£o Internacional â†’ Portugal â†’ Lisboa
    --          RestauraÃ§Ã£o Internacional â†’ Campo Espanha
    --          RestauraÃ§Ã£o Internacional â†’ AD Brasil (nacional) â†’ ...
    WHEN _parent_type = 'international_convention'
         AND _child_type IN ('national_convention', 'state_convention', 'convencao', 'matriz', 'sede')
    THEN true

    -- â”€â”€ Nacional â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    -- Nacional pode criar Estadual OU pular para Matriz/Sede diretamente.
    -- Suporta: AD Brasil â†’ CIEPADERGS (estadual)
    --          AD Brasil â†’ AD Caxias (matriz, sem convenÃ§Ã£o estadual formal)
    WHEN _parent_type = 'national_convention'
         AND _child_type IN ('state_convention', 'convencao', 'matriz', 'sede')
    THEN true

    -- â”€â”€ Estadual â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    WHEN _parent_type = 'state_convention'
         AND _child_type IN ('matriz', 'sede')
    THEN true

    -- ConvenÃ§Ã£o legada (compatibilidade)
    WHEN _parent_type = 'convencao'
         AND _child_type IN ('matriz', 'sede')
    THEN true

    -- â”€â”€ Municipal / Campo / Sede â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    -- Matriz/Sede podem criar Setor OU CongregaÃ§Ã£o direta (sem setor intermediÃ¡rio)
    ...
    -- â”€â”€ IntermediÃ¡rio â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    WHEN _parent_type = 'setor'
         AND _child_type = 'congregacao'
    THEN true

    -- â”€â”€ Todos os outros pares sÃ£o bloqueados â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    -- Inclui: congregacao criando qualquer filho
    --         setor criando matriz/sede/nacional/estadual
    --         qualquer filho criando seu pai ou avÃ´
    ELSE false
  END;
$$;
...
COMMENT ON FUNCTION public.is_valid_organization_hierarchy(_parent_type text, _child_type text) IS 'Valida pares parent/child de organization_type para hierarquia flexÃ­vel multi-cliente.
   Hierarquia AD Brasil:
     national_convention â†’ state_convention/convencao â†’ matriz/sede â†’ setor â†’ congregacao
   Hierarquia Internacional:
     international_convention â†’ national_convention/state_convention/matriz/sede â†’ ...
   Atalho permitido: matriz/sede â†’ congregacao (sem setor intermediÃ¡rio).
   MÃºltiplas raÃ­zes coexistem com parent_id IS NULL.';
...
COMMENT ON COLUMN public.members.photo_url IS 'URL da foto do membro â€” bucket avatars, path: members/{id}.{ext}';
...
COMMENT ON COLUMN public.members.marital_status IS 'Estado civil: Solteiro(a) | Casado(a) | Divorciado(a) | ViÃºvo(a) | Separado(a) | UniÃ£o EstÃ¡vel';
...
COMMENT ON COLUMN public.members.cpf IS 'CPF (texto livre, sem formataÃ§Ã£o obrigatÃ³ria)';
...
COMMENT ON COLUMN public.members.rg IS 'NÃºmero do RG';
...
COMMENT ON COLUMN public.members.rg_issuer IS 'Ã“rgÃ£o emissor do RG (ex: SSP/RS)';
...
COMMENT ON COLUMN public.members.rg_issue_date IS 'Data de emissÃ£o do RG';
...
COMMENT ON COLUMN public.members.whatsapp IS 'NÃºmero de WhatsApp (pode ser diferente do telefone)';
...
COMMENT ON COLUMN public.members.zip_code IS 'CEP do endereÃ§o';
...
COMMENT ON COLUMN public.members.address_number IS 'NÃºmero do endereÃ§o';
...
COMMENT ON COLUMN public.members.address_complement IS 'Complemento do endereÃ§o';
...
COMMENT ON COLUMN public.members.conversion_date IS 'Data de conversÃ£o/aceitaÃ§Ã£o';
...
COMMENT ON COLUMN public.members.administrative_role IS 'Cargo administrativo â€” separado da funÃ§Ã£o eclesiÃ¡stica';
...
COMMENT ON COLUMN public.members.mother_name IS 'Nome da mÃ£e';
...
COMMENT ON COLUMN public.members.spouse_name IS 'Nome do cÃ´njuge';
...
COMMENT ON COLUMN public.members.congregation_id IS 'CongregaÃ§Ã£o especÃ­fica onde o membro congrega';
...
COMMENT ON COLUMN public.members.civil_document_type IS 'Tipo de certidÃƒÂ£o exigida: CertidÃƒÂ£o de nascimento | CertidÃƒÂ£o de casamento | CertidÃƒÂ£o de divÃƒÂ³rcio';
...
COMMENT ON COLUMN public.members.civil_document_status IS 'Status da documentaÃƒÂ§ÃƒÂ£o civil: Pendente | Apresentado | Validado | Rejeitado';
...
COMMENT ON COLUMN public.members.civil_document_url IS 'URL do arquivo/anexo da certidÃƒÂ£o (Supabase Storage ou externo)';
...
COMMENT ON COLUMN public.members.civil_document_notes IS 'ObservaÃƒÂ§ÃƒÂµes da secretaria sobre a documentaÃƒÂ§ÃƒÂ£o civil';
...
COMMENT ON COLUMN public.members.civil_document_validated_by IS 'UsuÃƒÂ¡rio (secretaria) que validou o documento';
...
COMMENT ON COLUMN public.members.holy_spirit_baptism_date IS 'Data do batismo com o EspÃƒÂ­rito Santo (glossolalia)';
...
COMMENT ON COLUMN public.members.consecration_date IS 'Data de consagraÃƒÂ§ÃƒÂ£o ministerial (Auxiliar, DiÃƒÂ¡cono, PresbÃƒÂ­tero, Evangelista, Pastor)';
...
COMMENT ON TABLE public.organization_affiliations IS 'Agrupamentos/vÃ­nculos laterais entre organizaÃ§Ãµes (fraternas, grupos regionais, eventos).
   NÃƒO Ã© relaÃ§Ã£o parent/child hierÃ¡rquica â€” nÃ£o substitui Setor/Distrito.
...
COMMENT ON TABLE public.organization_hierarchy_rules IS 'REFERÃŠNCIA DOCUMENTACIONAL das regras de hierarquia organizacional.
   A validaÃ§Ã£o executÃ¡vel estÃ¡ na funÃ§Ã£o is_valid_organization_hierarchy().
   Esta tabela serve para documentaÃ§Ã£o, auditoria e futura externalizaÃ§Ã£o das regras.';
...
COMMENT ON TABLE public.organization_responsibles IS 'ResponsÃ¡veis formais por unidade (pastor, secretÃ¡rio, tesoureiro, contato principal).
...
COMMENT ON COLUMN public.organizations.unit_status IS 'Status operacional da unidade: Ativa | Em implantaÃ§Ã£o | Inativa | Arquivada';
...
COMMENT ON COLUMN public.organizations.intermediate_level_label IS 'Nome singular do nÃ­vel intermediÃ¡rio. Ex: Setor, Distrito, RegiÃ£o, Ãrea, Campo';
...
COMMENT ON COLUMN public.organizations.local_unit_label IS 'Nome singular da unidade local. Ex: CongregaÃ§Ã£o, Igreja local, Filial, Campus, Templo';
...
COMMENT ON COLUMN public.organizations.uses_intermediate_level IS 'Se false, a Matriz gerencia unidades locais diretamente (sem nÃ­vel intermediÃ¡rio).';
...
COMMENT ON COLUMN public.organizations.zip_code IS 'CEP ou cÃ³digo postal da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.street IS 'Rua/logradouro da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.address_number IS 'NÃºmero do endereÃ§o da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.address_complement IS 'Complemento do endereÃ§o da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.neighborhood IS 'Bairro da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.website_url IS 'Site institucional da unidade/organizaÃ§Ã£o.';
...
COMMENT ON COLUMN public.organizations.has_operational_cashbox IS 'Unidade opera caixa prÃ³prio (operacional). PadrÃ£o true.';
...
COMMENT ON COLUMN public.organizations.is_financially_autonomous IS 'Unidade tem autonomia financeira plena (nÃ£o consolida para cima). PadrÃ£o false.';
...
COMMENT ON COLUMN public.organizations.financially_consolidates_to_id IS 'ReferÃªncia da unidade para a qual esta consolida seu financeiro.';
...
COMMENT ON COLUMN public.organizations.cnpj IS 'CNPJ da unidade (pessoa jurÃ­dica prÃ³pria).';
...
COMMENT ON COLUMN public.organizations.financial_policy_notes IS 'Notas de polÃ­tica financeira desta unidade.';
...
COMMENT ON TABLE public.platform_support_agent_departments IS 'VÃ­nculo entre agentes da plataforma e departamentos de suporte.';
...
COMMENT ON TABLE public.platform_support_agent_presence IS 'HistÃ³rico de presenÃ§a/status dos agentes de suporte.';
...
COMMENT ON TABLE public.platform_support_audit_logs IS 'Auditoria das aÃ§Ãµes de suporte/plataforma dentro de organizaÃ§Ãµes atendidas.';
...
COMMENT ON TABLE public.platform_support_departments IS 'Departamentos dinÃ¢micos de suporte da plataforma Ecclesia.';
...
COMMENT ON TABLE public.platform_support_permissions IS 'Matriz documentacional de permissÃµes por perfil de suporte da plataforma.';
...
COMMENT ON TABLE public.platform_support_ticket_events IS 'HistÃ³rico imutÃ¡vel de eventos dos chamados de suporte.';
...
COMMENT ON TABLE public.platform_support_tickets IS 'Chamados de suporte abertos pelas organizaÃ§Ãµes/clientes da plataforma.';
...
COMMENT ON COLUMN public.platform_support_tickets.department_id IS 'Departamento dinÃ¢mico responsÃ¡vel pelo chamado. MantÃ©m department text como fallback legado.';
...
b83592ee-bdfa-4b8e-9839-14bd4eaf9da3	51b169ef9b989e5a0a247a274189469b9f0085c33b249ac3	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	Edson GonÃ§alves Roquete	dinhoroquete@gmail.com	\N	member	pending	2026-06-25 02:50:25.79654+00	\N	\N	2026-06-18 02:50:25.79654+00
...
dd000015-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	Marcos Antonio Bettega	declaracao_membro	Solicita declaraÃ§Ã£o de membro ativo para fins de financiamento habitacional.	aberta	\N	\N	\N	2026-06-13 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	Paulo Antoniazzi	solicitacao_geral	Solicita informaÃ§Ãµes sobre agenda de atendimento pastoral.	aberta	\N	\N	\N	2026-06-12 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	\N	Ana Paula Zanella	segunda_via	Segunda via do cartÃ£o de membro. Original extraviado.	em_analise	\N	Aguardar confirmaÃ§Ã£o de identidade presencial.	\N	2026-06-10 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	\N	Leandro Basso	contato_pastoral	Precisa de orientaÃ§Ã£o pastoral para situaÃ§Ã£o familiar.	em_analise	\N	Agendado para conversa reservada.	\N	2026-06-11 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	\N	Simone Polesso	atualizacao_cadastral	AtualizaÃ§Ã£o do estado civil apÃ³s casamento em 03/05/2026.	em_analise	\N	\N	\N	2026-06-09 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000007	10000000-0000-0000-0000-000000000002	\N	Rodrigo Maran	declaracao_membro	DeclaraÃ§Ã£o para apresentaÃ§Ã£o em assembleia condominial.	aguardando_documento	\N	Solicitar foto 3x4 atualizada.	\N	2026-06-05 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000008	10000000-0000-0000-0000-000000000002	\N	Cristiane Degasperi	segunda_via	Segunda via do histÃ³rico de batismo. Documento necessÃ¡rio para transferÃªncia.	aguardando_documento	\N	Membro deve trazer testemunho de dois membros antigos.	\N	2026-06-07 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000009	10000000-0000-0000-0000-000000000002	\N	Thiago Volpato	atualizacao_cadastral	AtualizaÃ§Ã£o de dados por mudanÃ§a de cidade. Nova cidade: Porto Alegre/RS.	concluida	\N	\N	2026-06-03 23:04:54.772+00	2026-06-01 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-00000000000a	10000000-0000-0000-0000-000000000002	\N	Camila Dallacosta	declaracao_membro	DeclaraÃ§Ã£o de membro para inscriÃ§Ã£o em curso de formaÃ§Ã£o ministerial.	concluida	\N	\N	2026-06-08 23:04:54.772+00	2026-06-06 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-00000000000b	10000000-0000-0000-0000-000000000002	\N	Anderson Cominetto	contato_pastoral	Solicitou visita domiciliar apÃ³s alta hospitalar.	concluida	\N	\N	2026-06-12 23:04:54.772+00	2026-06-02 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-00000000000c	10000000-0000-0000-0000-000000000002	\N	Elisangela Mantovani	solicitacao_geral	SolicitaÃ§Ã£o de uso do salÃ£o para evento de casamento. Fora do padrÃ£o da polÃ­tica.	rejeitada	\N	SalÃ£o Ã© exclusivo para atividades ministeriais.	2026-06-11 23:04:54.772+00	2026-06-09 23:04:54.772+00	2026-06-15 23:04:55.918569+00
dd000015-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	\N	Fernanda Tonetto	atualizacao_cadastral	AtualizaÃ§Ã£o de endereÃ§o e telefone apÃ³s mudanÃ§a de bairro.	aberta	\N	\N	2026-06-22 16:10:03.502+00	2026-06-14 23:04:54.772+00	2026-06-22 16:10:07.348281+00
\.
...
aaaaaaaa-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	\N	Assembleia Geral OrdinÃ¡ria â€” Maio 2026	CONVOCAÃ‡ÃƒO\nA CongregaÃ§Ã£o Jardim AmÃ©rica, da Assembleia de Deus em Caxias do Sul/RS, convoca todos os membros e obreiros para a Assembleia Geral OrdinÃ¡ria, no dia 18 de maio de 2026, Ã s 19h30, no Templo da CongregaÃ§Ã£o, Caxias do Sul.\n\nPAUTA\n1. Abertura em oraÃ§Ã£o e leitura bÃ­blica\n2. RelatÃ³rio pastoral do trimestre\n3. PrestaÃ§Ã£o de contas da Tesouraria\n4. OrganizaÃ§Ã£o dos ministÃ©rios para o 2Âº semestre de 2026\n5. CalendÃ¡rio de eventos congregacionais e missÃµes locais\n6. Assuntos gerais e encaminhamentos\n\nDECISÃ•ES REGISTRADAS\nâ€¢ AprovaÃ§Ã£o do relatÃ³rio financeiro apresentado pela Tesouraria\nâ€¢ AutorizaÃ§Ã£o do calendÃ¡rio de cultos especiais de junho/2026\nâ€¢ ReforÃ§o da mobilizaÃ§Ã£o da EBD e dos Pequenos Grupos (Jovens Resgate e Casais Ãgape)\nâ€¢ Encaminhamento Ã  Secretaria para atualizaÃ§Ã£o cadastral dos membros ativos	2Âº Trimestre 2026	2026-05-18	\N	\N	\N	t	2026-06-05 19:24:47.926245+00	2026-06-05 19:27:54.714886+00
aaaaaaaa-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	\N	Assembleia Ministerial â€” OrganizaÃ§Ã£o dos MinistÃ©rios	CONVOCAÃ‡ÃƒO\nReuniÃ£o ministerial da CongregaÃ§Ã£o Jardim AmÃ©rica para alinhamento das lideranÃ§as de Louvor, Infantil, Jovens, RecepÃ§Ã£o, IntercessÃ£o e MÃ­dia, em Caxias do Sul/RS.\n\nPAUTA\n1. RevisÃ£o das escalas de junho/2026\n2. Metas de discipulado por ministÃ©rio\n3. IntegraÃ§Ã£o de novos obreiros\n4. ComunicaÃ§Ã£o com a Secretaria AD Caxias do Sul\n\nDECISÃ•ES REGISTRADAS\nâ€¢ ConfirmaÃ§Ã£o das equipes de Louvor e RecepÃ§Ã£o para os cultos dominicais\nâ€¢ InÃ­cio da mobilizaÃ§Ã£o do SeminÃ¡rio de LideranÃ§a congregacional\nâ€¢ PadronizaÃ§Ã£o dos relatÃ³rios mensais enviados Ã  Secretaria	Maio 2026	2026-05-10	\N	\N	\N	t	2026-06-05 19:24:47.926245+00	2026-06-05 19:47:53.497066+00
dd00000d-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	Assembleia Geral OrdinÃ¡ria 2025	RelatÃ³rio pastoral/financeiro, eleiÃ§Ã£o diretoria e aprovaÃ§Ã£o construÃ§Ã£o novo templo.	\N	2025-11-28	2025-11-28 19:30:00+00	2025-11-28 22:30:00+00	\N	t	2026-06-15 21:46:47.925623+00	2026-06-15 21:46:47.925623+00
dd00000d-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	\N	Assembleia ExtraordinÃ¡ria â€” CrÃ©dito de Obra	VotaÃ§Ã£o para aprovaÃ§Ã£o de crÃ©dito para aceleraÃ§Ã£o da obra do novo templo.	\N	2026-03-15	2026-03-15 19:00:00+00	2026-03-15 21:30:00+00	\N	t	2026-06-15 21:46:47.925623+00	2026-06-15 21:46:47.925623+00
dd00000d-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	Assembleia Geral OrdinÃ¡ria 2026	RelatÃ³rio semestral, calendÃ¡rio de missÃµes e plano de aÃ§Ã£o 2Âº semestre.	\N	2026-07-26	2026-07-26 19:00:00+00	2026-07-26 22:00:00+00	\N	t	2026-06-15 21:46:47.925623+00	2026-06-15 21:46:47.925623+00
\.
...
aaaaaaaa-0000-0000-0000-000000000011	aaaaaaaa-0000-0000-0000-000000000001	Ata da Assembleia Geral OrdinÃ¡ria â€” Maio 2026	\N	\N	\N	minutes	2026-06-05 19:24:47.926245+00
aaaaaaaa-0000-0000-0000-000000000012	aaaaaaaa-0000-0000-0000-000000000001	RelatÃ³rio Financeiro â€” 2Âº Trimestre 2026	\N	\N	\N	report	2026-06-05 19:24:47.926245+00
aaaaaaaa-0000-0000-0000-000000000021	aaaaaaaa-0000-0000-0000-000000000002	Ata da Assembleia Ministerial â€” Maio 2026	\N	\N	\N	minutes	2026-06-05 19:24:47.926245+00
...
bbbbbbbb-0000-0000-0000-000000000001	aaaaaaaa-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000002	\N	Nova foto adicionada	Registro fotogrÃ¡fico da fachada em revitalizaÃ§Ã£o.	\N	media	2026-05-24 14:00:00+00
bbbbbbbb-0000-0000-0000-000000000002	aaaaaaaa-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000002	\N	Meta atingiu 50%	Campanha MissÃµes Ãfrica alcanÃ§ou metade da meta financeira.	\N	progress	2026-05-22 10:30:00+00
bbbbbbbb-0000-0000-0000-000000000003	aaaaaaaa-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	\N	PrestaÃ§Ã£o de contas publicada	RelatÃ³rio de entrega de cobertores e cestas bÃ¡sicas disponÃ­vel.	\N	accountability	2026-05-20 16:45:00+00
bbbbbbbb-0000-0000-0000-000000000004	aaaaaaaa-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000002	\N	RelatÃ³rio fotogrÃ¡fico da obra	AvanÃ§o da alvenaria e cobertura da congregaÃ§Ã£o SÃ£o JosÃ©.	\N	media	2026-05-18 09:15:00+00
bbbbbbbb-0000-0000-0000-000000000005	aaaaaaaa-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000002	\N	InscriÃ§Ãµes abertas	Congresso de Jovens 2026 â€” inscriÃ§Ãµes pelo ministÃ©rio.	\N	progress	2026-05-15 11:00:00+00
bbbbbbbb-0000-0000-0000-000000000006	aaaaaaaa-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000002	\N	OrÃ§amento da van aprovado	Conselho missionÃ¡rio aprovou orÃ§amento preliminar do veÃ­culo.	\N	progress	2026-05-25 11:00:00+00
bbbbbbbb-0000-0000-0000-000000000007	aaaaaaaa-0000-0000-0000-000000000007	11111111-0000-0000-0000-000000000002	\N	Meta atingiu 60%	Campanha de instrumentos alcanÃ§ou 60% da meta.	\N	progress	2026-05-23 18:30:00+00
bbbbbbbb-0000-0000-0000-000000000008	aaaaaaaa-0000-0000-0000-000000000008	11111111-0000-0000-0000-000000000004	\N	Projeto apresentado Ã  congregaÃ§Ã£o	Capela de OraÃ§Ã£o 24h apresentada no culto de domingo.	\N	progress	2026-05-21 09:00:00+00
bbbbbbbb-0000-0000-0000-000000000009	aaaaaaaa-0000-0000-0000-000000000009	11111111-0000-0000-0000-000000000002	\N	InscriÃ§Ãµes abrem em junho	Encontro de Mulheres 2026 â€” inscriÃ§Ãµes a partir de 01/06.	\N	progress	2026-05-19 14:00:00+00
\.
...
aaaaaaaa-0000-0000-0000-000000000008	11111111-0000-0000-0000-000000000004	\N	\N	Capela de OraÃ§Ã£o 24h	Projeto ministerial de capela de oraÃ§Ã£o contÃ­nua na CongregaÃ§Ã£o Jardim AmÃ©rica: adequaÃ§Ã£o do espaÃ§o, climatizaÃ§Ã£o e mobiliÃ¡rio.	projeto_ministerial	closed	28000.00	9600.00	2026-05-01	2026-12-01	/campaigns/prayer/prayer-06.jpg	organization	normal	2026-06-08 22:54:46.025+00	2026-06-08 20:25:37.117761+00	2026-06-26 17:10:21.840165+00	f	f
aaaaaaaa-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000002	\N	\N	VeÃ­culo para MissÃµes Regionais	AquisiÃ§Ã£o de van para transporte de equipes missionÃ¡rias, visitas a congregaÃ§Ãµes do interior e aÃ§Ã£o social nas comunidades da regiÃ£o da Serra.	veiculos	active	165000.00	78300.00	2026-03-01	2026-10-15	\N	hierarchy	normal	2026-05-14 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	f	f
aaaaaaaa-0000-0000-0000-000000000007	11111111-0000-0000-0000-000000000002	\N	\N	Instrumentos para Louvor	RenovaÃ§Ã£o do parque de instrumentos do ministÃ©rio de louvor: teclado, bateria, amplificadores e microfones sem fio para cultos e eventos.	instrumentos	active	52000.00	31400.00	2026-04-10	2026-07-20	\N	organization	normal	2026-05-21 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	f	f
aaaaaaaa-0000-0000-0000-000000000009	11111111-0000-0000-0000-000000000002	\N	\N	Encontro de Mulheres 2026	RealizaÃ§Ã£o do Encontro de Mulheres com tema Mulheres de FÃ© â€” palestras, momentos de oraÃ§Ã£o, aÃ§Ã£o social e kit para participantes.	evento	draft	22000.00	4200.00	2026-06-01	2026-09-05	\N	organization	low	2026-06-03 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	2026-06-08 20:25:37.117761+00	f	f
aaaaaaaa-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000002	\N	\N	Reforma do Templo Central	RevitalizaÃ§Ã£o do templo da sede da Assembleia de Deus em Caxias do Sul: pintura externa, adequaÃ§Ã£o elÃ©trica, acessibilidade e salas de EBD.	reforma	active	180000.00	112500.00	2026-01-15	2026-09-30	\N	organization	high	2026-05-09 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	2026-06-08 21:26:08.634536+00	t	f
d6b5e615-b6c2-4287-b4c7-d79a505090c0	11111111-0000-0000-0000-000000000004	3a7e972d-f9d5-417a-984c-3652d6c2f28f	\N	Ganhando Almas	A campanha Ganhando Almas tem como propÃ³sito fortalecer a evangelizaÃ§Ã£o e alcanÃ§ar novas vidas para Cristo atravÃ©s de aÃ§Ãµes missionÃ¡rias, visitas, distribuiÃ§Ã£o de materiais evangelÃ­sticos, eventos e apoio aos voluntÃ¡rios envolvidos na obra. Os recursos arrecadados serÃ£o destinados Ã  expansÃ£o das atividades evangelÃ­sticas, aquisiÃ§Ã£o de materiais e suporte Ã s equipes que atuam na proclamaÃ§Ã£o do Evangelho. Nosso objetivo Ã© levar esperanÃ§a, fÃ© e transformaÃ§Ã£o a mais pessoas, cumprindo a missÃ£o de anunciar Jesus Cristo e fazer discÃ­pulos.	missoes	active	50000.00	0.00	2026-07-02	2026-08-02	\N	organization	high	2026-06-08 22:06:00.105+00	2026-06-08 22:06:02.371566+00	2026-06-08 22:06:02.371566+00	f	t
...
aaaaaaaa-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000002	\N	\N	ConstruÃ§Ã£o CongregaÃ§Ã£o SÃ£o JosÃ©	Obra da nova congregaÃ§Ã£o SÃ£o JosÃ© em Caxias do Sul/RS: fundaÃ§Ã£o concluÃ­da, fase de alvenaria e cobertura.	construcao	active	420000.00	268400.00	2025-06-01	2027-03-15	\N	organization	normal	2026-04-09 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	f	f
aaaaaaaa-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000002	\N	\N	MissÃµes Ãfrica	Envio de equipe missionÃ¡ria e apoio logÃ­stico para projetos de plantaÃ§Ã£o de igrejas e aÃ§Ã£o social em MoÃ§ambique.	missoes	active	95000.00	61200.00	2026-02-01	2026-11-20	\N	hierarchy	normal	2026-04-24 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	f	f
aaaaaaaa-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	\N	\N	AÃ§Ã£o Social Inverno	DistribuiÃ§Ã£o de cobertores, cestas bÃ¡sicas e kits de higiene para famÃ­lias em vulnerabilidade em Caxias do Sul.	acao_social	closed	35000.00	35000.00	2026-03-01	2026-06-30	\N	organization	normal	2026-03-10 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	f	f
aaaaaaaa-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000002	\N	\N	Congresso de Jovens	RealizaÃ§Ã£o do Congresso de Jovens 2026 com palestras, workshops e mobilizaÃ§Ã£o dos ministÃ©rios Jovens Resgate da regiÃ£o.	congresso	active	48000.00	19800.00	2026-04-01	2026-08-10	\N	organization	normal	2026-05-19 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	f	f
\.
...
44444444-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	Bem-vindos ao Ecclesia Admin	Prezados irmÃ£os, com muito jÃºbilo anunciamos a implantaÃ§Ã£o do Ecclesia Admin â€” nosso novo sistema de gestÃ£o pastoral integrada. Acesse pelo computador ou celular para acompanhar eventos, comunicados, devocionais, financeiro e muito mais. Deus seja louvado por esta conquista!	Normal	t	\N	2026-05-19 09:00:00+00	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
44444444-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	SeminÃ¡rio de LideranÃ§a â€” InscriÃ§Ãµes Abertas	O SeminÃ¡rio de LideranÃ§a acontecerÃ¡ no dia 06 de junho (sÃ¡bado), das 9h Ã s 17h, no AuditÃ³rio Central. Palestrantes confirmados: Pr. Marcos Oliveira (RJ) e Pastora Ana Lima (SP). Vagas limitadas a 80 participantes. InscriÃ§Ãµes na secretaria ou pelo app.	Importante	t	\N	2026-05-18 14:00:00+00	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
44444444-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	Congresso de OraÃ§Ã£o e MissÃµes â€” 13 e 14 de junho	Realizaremos nosso Congresso Anual de OraÃ§Ã£o e MissÃµes com o tema "AtÃ© os Confins da Terra" (Atos 1:8). ProgramaÃ§Ã£o: pregaÃ§Ãµes, momentos de intercessÃ£o, testemunhos missionÃ¡rios e oferta especial para missÃµes nacionais. Toda a famÃ­lia estÃ¡ convidada!	Importante	t	\N	2026-05-15 10:00:00+00	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
44444444-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	AtualizaÃ§Ã£o de Cadastro â€” Prazo: 30 de maio	Solicitamos que todos os membros regularizem seu cadastro junto Ã  secretaria atÃ© o dia 30 de maio. Ã‰ necessÃ¡rio apresentar: documento oficial com foto e comprovante de residÃªncia atualizado. HorÃ¡rio de atendimento: segunda a sexta, 9h Ã s 17h.	Normal	t	\N	2026-05-10 08:00:00+00	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
...
dd00000e-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Campanha de DÃ­zimos â€” ConstruÃ§Ã£o do Novo Templo	IrmÃ£os, a obra do nosso novo templo avanÃ§a. Participem da campanha de dÃ­zimos. Meta 2Âº semestre: R$ 80.000.	Importante	t	\N	2026-06-05 21:46:47.979+00	\N	2026-06-15 21:46:48.993186+00	2026-06-15 21:46:48.993186+00
dd00000e-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	Santa Ceia â€” 28 de Junho	Convidamos todos os membros em plena comunhÃ£o para a Santa Ceia, dia 28/06 Ã s 19h. Venha preparado!	Normal	t	\N	2026-06-10 21:46:47.979+00	\N	2026-06-15 21:46:48.993186+00	2026-06-15 21:46:48.993186+00
dd00000e-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	ConvocaÃ§Ã£o: ReuniÃ£o de Obreiros â€” 18/06	PresenÃ§a obrigatÃ³ria de todos os obreiros e lÃ­deres na reuniÃ£o de planejamento do 2Âº semestre, 18/06 Ã s 19h.	Importante	f	\N	2026-06-07 21:46:47.979+00	\N	2026-06-15 21:46:48.993186+00	2026-06-15 21:46:48.993186+00
dd00000e-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	AtualizaÃ§Ã£o de Cadastro â€” Prazo: 30/06	Membros devem atualizar cadastro na secretaria atÃ© 30/06. Documentos: foto + comprovante. Seg-Sex 9hâ€“17h.	Normal	t	\N	2026-05-31 21:46:47.979+00	\N	2026-06-15 21:46:48.993186+00	2026-06-15 21:46:48.993186+00
dd00000e-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	ConferÃªncia de Jovens 2026 â€” InscriÃ§Ãµes Abertas	ConferÃªncia de Jovens 2026 confirmada! Inscreva-se atÃ© 10/07. Vagas limitadas.	Normal	t	\N	2026-06-12 21:46:47.979+00	\N	2026-06-15 21:46:48.993186+00	2026-06-15 21:46:48.993186+00
\.
...
55555555-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	Ata de ReuniÃ£o Ministerial â€” Maio 2026	ATA DE REUNIÃƒO MINISTERIAL\r\nAssembleia de Deus em Caxias do Sul â€” CongregaÃ§Ã£o Jardim AmÃ©rica\r\nData: 10 de maio de 2026 | HorÃ¡rio: 19h30 | Local: SalÃ£o de ReuniÃµes\r\n\r\nPresentes: Pr. JoÃ£o Paulo Ferreira (Pastor), Fernanda Maria Alves (Secretaria), lideranÃ§as dos ministÃ©rios de Louvor, Infantil, Jovens, RecepÃ§Ã£o e IntercessÃ£o.\r\n\r\nPAUTA:\r\n1. Abertura em oraÃ§Ã£o e leitura bÃ­blica.\r\n2. Planejamento dos cultos e atividades de junho/2026 na sede de Caxias do Sul.\r\n3. Escalas ministeriais: confirmaÃ§Ã£o das equipes de Louvor e RecepÃ§Ã£o.\r\n4. MobilizaÃ§Ã£o da EBD e dos Pequenos Grupos (Jovens Resgate e Casais Ãgape).\r\n5. OrientaÃ§Ãµes da Secretaria sobre cadastro de membros e documentaÃ§Ã£o congregacional.\r\n\r\nEncerramento Ã s 21h00, com benÃ§Ã£o apostÃ³lica.\r\n\r\nPr. JoÃ£o Paulo Ferreira â€” Pastor\r\nFernanda Maria Alves â€” Secretaria AD Caxias do Sul / CongregaÃ§Ã£o Jardim AmÃ©rica	Ata	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 17:28:09.501145+00
55555555-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	Estatuto Interno â€” Assembleia de Deus Caxias do Sul	ESTATUTO INTERNO â€” CONGREGAÃ‡ÃƒO JARDIM AMÃ‰RICA\r\nASSEMBLEIA DE DEUS EM CAXIAS DO SUL\r\n\r\nCAPÃTULO I â€” DA IDENTIFICAÃ‡ÃƒO\r\nArt. 1Âº â€” A CongregaÃ§Ã£o Jardim AmÃ©rica, localizada em Caxias do Sul/RS, Ã© congregaÃ§Ã£o da Assembleia de Deus em Caxias do Sul, entidade religiosa sem fins lucrativos, sob orientaÃ§Ã£o pastoral e regimento interno da Secretaria administrativa da obra.\r\n\r\nCAPÃTULO II â€” DOS OBJETIVOS\r\nArt. 2Âº â€” SÃ£o objetivos da CongregaÃ§Ã£o:\r\na) Pregar o Evangelho de Jesus Cristo;\r\nb) Promover adoraÃ§Ã£o, discipulado e santa comunhÃ£o;\r\nc) Servir Ã  cidade de Caxias do Sul em missÃµes e aÃ§Ã£o social.\r\n\r\nCAPÃTULO III â€” DOS MEMBROS\r\nArt. 3Âº â€” SÃ£o membros os que confessam fÃ© evangÃ©lica, sÃ£o integrados pela lideranÃ§a pastoral e acompanhados pela Secretaria da congregaÃ§Ã£o.\r\n\r\nCAPÃTULO IV â€” DA ADMINISTRAÃ‡ÃƒO\r\nArt. 4Âº â€” A CongregaÃ§Ã£o Ã© administrada pelo Pastor local, pastores auxiliares, presbÃ­teros, diÃ¡conos e lideranÃ§as ministeriais, em harmonia com a direÃ§Ã£o da Assembleia de Deus em Caxias do Sul.	Estatuto	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 17:28:09.501145+00
55555555-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	Manual de IntegraÃ§Ã£o de Novos Membros â€” AD Caxias do Sul	MANUAL DE INTEGRAÃ‡ÃƒO DE NOVOS MEMBROS\r\nAssembleia de Deus em Caxias do Sul â€” CongregaÃ§Ã£o Jardim AmÃ©rica\r\n\r\nBEM-VINDO Ã€ FAMÃLIA DE DEUS!\r\n\r\nA Secretaria da CongregaÃ§Ã£o Jardim AmÃ©rica preparou este material para ajudÃ¡-lo a integrar-se Ã  vida congregacional da Assembleia de Deus em Caxias do Sul.\r\n\r\nNOSSA IDENTIDADE\r\nSomos uma congregaÃ§Ã£o evangÃ©lica pentecostal, comprometida com a Palavra de Deus, a oraÃ§Ã£o e a obra missionÃ¡ria na cidade de Caxias do Sul.\r\n\r\nMINISTÃ‰RIOS DA CONGREGAÃ‡ÃƒO\r\nâ€¢ Louvor e AdoraÃ§Ã£o\r\nâ€¢ Infantil\r\nâ€¢ Jovens Resgate\r\nâ€¢ Casais Ãgape\r\nâ€¢ RecepÃ§Ã£o e Acolhimento\r\nâ€¢ IntercessÃ£o\r\nâ€¢ Escola BÃ­blica Dominical\r\n\r\nPRIMEIROS PASSOS\r\n1. Participar do culto de boas-vindas\r\n2. Encontro com a lideranÃ§a pastoral\r\n3. Cadastro na Secretaria (documento com foto e dados pessoais)\r\n4. InscriÃ§Ã£o em um ministÃ©rio ou pequeno grupo\r\n\r\nCONTATOS\r\nPastor JoÃ£o Paulo Ferreira â€” (11) 99999-0001\r\nSecretaria AD Caxias do Sul / CongregaÃ§Ã£o Jardim AmÃ©rica â€” seg a sex, 9h Ã s 17h	Geral	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 17:28:09.501145+00
dd000009-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Ata da Assembleia Geral OrdinÃ¡ria 2025	ATA DA ASSEMBLEIA GERAL ORDINÃRIA 2025 â€” Assembleia de Deus em Caxias do Sul. Data: 28/11/2025, 19h30, Templo Sede. Presentes: 87 membros. Pauta: relatÃ³rio pastoral, financeiro, eleiÃ§Ã£o diretoria, aprovaÃ§Ã£o projeto de construÃ§Ã£o. Resultado: aprovado por unanimidade.	Ata	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
dd000009-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	DeclaraÃ§Ã£o de Membro â€” Sergio Bortolanza	DECLARAÃ‡ÃƒO DE MEMBRO. A Assembleia de Deus em Caxias do Sul declara que o Pr. Sergio Luiz Bortolanza Ã© membro em plena comunhÃ£o desde 10/01/2010. Emitido para os devidos fins.	DeclaraÃ§Ã£o	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
dd000009-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	Estatuto Social â€” AD Caxias do Sul	ESTATUTO SOCIAL â€” ASSEMBLEIA DE DEUS EM CAXIAS DO SUL. Entidade religiosa sem fins lucrativos, Caxias do Sul, RS. Objetivos: pregar o Evangelho, promover adoraÃ§Ã£o e discipulado, missÃµes e aÃ§Ã£o social.	Estatuto	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
dd000009-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	RelatÃ³rio Financeiro Semestral 1Âº Sem 2026	RELATÃ“RIO FINANCEIRO 1Âº SEMESTRE 2026. RECEITAS: DÃ­zimos R$34.600, Ofertas R$9.850, MissÃµes R$8.500, ConstruÃ§Ã£o R$18.200. TOTAL RECEITAS: R$71.150. DESPESAS: R$70.250. SALDO: R$900.	RelatÃ³rio	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
dd000009-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	AutorizaÃ§Ã£o de Uso de Imagem â€” MinistÃ©rio Infantil	AUTORIZAÃ‡ÃƒO DE USO DE IMAGEM. Autorizamos o uso da imagem de nosso filho(a) nas atividades do MinistÃ©rio Infantil da Assembleia de Deus em Caxias do Sul, para fins eclesiÃ¡sticos sem fins lucrativos.	AutorizaÃ§Ã£o	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
dd000009-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	Carta de RecomendaÃ§Ã£o Arquivada â€” Fernanda Pasinato	CARTA DE RECOMENDAÃ‡ÃƒO ARQUIVADA. Emitida em 21/05/2026 para Fernanda Pasinato, destinada Ã  Assembleia de Deus â€” Campinas â€” FlorianÃ³polis/SC. Aprovada e validada via Ecclesia Online â€” cÃ³digo DD000004.	Carta de RecomendaÃ§Ã£o	\N	\N	2026-06-15 21:46:42.279126+00	2026-06-16 21:53:27.197884+00
\.
...
33333333-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” Domingo	\N	2026-05-24 10:00:00+00	2026-05-24 12:00:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	Culto da FamÃ­lia	\N	2026-05-24 19:00:00+00	2026-05-24 20:30:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	Culto de OraÃ§Ã£o â€” Quarta	\N	2026-05-27 19:30:00+00	2026-05-27 21:00:00+00	SalÃ£o de ReuniÃµes	bg-primary	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	ReuniÃ£o de Jovens	\N	2026-05-30 19:00:00+00	2026-05-30 21:00:00+00	SalÃ£o dos Jovens	bg-primary	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” Domingo	\N	2026-05-31 10:00:00+00	2026-05-31 12:00:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000004	SeminÃ¡rio de LideranÃ§a	\N	2026-06-06 09:00:00+00	2026-06-06 17:00:00+00	AuditÃ³rio Central	bg-success	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000007	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” Domingo	\N	2026-06-07 10:00:00+00	2026-06-07 12:00:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000008	11111111-0000-0000-0000-000000000004	Congresso de OraÃ§Ã£o e MissÃµes	\N	2026-06-13 19:00:00+00	2026-06-14 18:00:00+00	Templo Principal	bg-success	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000009	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” Domingo	\N	2026-06-14 10:00:00+00	2026-06-14 12:00:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000010	11111111-0000-0000-0000-000000000004	Culto de AniversÃ¡rio da Igreja	\N	2026-06-21 10:00:00+00	2026-06-21 13:00:00+00	Templo Principal	bg-accent	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
33333333-0000-0000-0000-000000000011	11111111-0000-0000-0000-000000000004	Retiro de Casais	\N	2026-06-27 08:00:00+00	2026-06-29 18:00:00+00	Centro de Retiros BetÃ¢nia	bg-primary	t	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00
dd00000a-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Culto de Ensino â€” Domingo	Tema: FÃ© que move montanhas.	2026-06-21 10:00:00+00	2026-06-21 12:00:00+00	Templo Sede	bg-accent	t	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
dd00000a-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	ReuniÃ£o de Obreiros	ReuniÃ£o mensal de planejamento com obreiros da Matriz.	2026-06-18 19:00:00+00	2026-06-18 21:00:00+00	SalÃ£o Paroquial	bg-primary	f	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
dd00000a-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	Escola BÃ­blica Dominical	Estudo por faixa etÃ¡ria. Tema: EpÃ­stola aos Romanos.	2026-06-22 09:00:00+00	2026-06-22 10:00:00+00	Salas de Ensino	bg-success	t	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
dd00000a-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	Ensaio do Louvor	Ensaio semanal da equipe de louvor e mÃºsicos.	2026-06-17 19:30:00+00	2026-06-17 21:30:00+00	Templo Sede	bg-primary	f	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
...
dd00000a-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	Santa Ceia	CelebraÃ§Ã£o da Santa Ceia no culto da famÃ­lia.	2026-06-28 19:00:00+00	2026-06-28 21:00:00+00	Templo Sede	bg-success	t	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
dd00000a-0000-0000-0000-000000000007	10000000-0000-0000-0000-000000000002	ReuniÃ£o da Secretaria	ReuniÃ£o administrativa mensal.	2026-06-25 14:00:00+00	2026-06-25 16:00:00+00	Sala Secretaria	bg-primary	f	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
dd00000a-0000-0000-0000-000000000008	10000000-0000-0000-0000-000000000002	Culto de OraÃ§Ã£o â€” Quarta	Culto de oraÃ§Ã£o e intercessÃ£o semanal.	2026-06-25 19:30:00+00	2026-06-25 21:00:00+00	Templo Sede	bg-accent	t	\N	2026-06-15 21:46:43.317395+00	2026-06-15 21:46:43.317395+00
\.
...
99999999-0000-0000-0000-000000000001	66666666-0000-0000-0000-000000000001	00000000-0000-0000-0000-00000000b001	Bem-vindos ao grupo Jovens Resgate! Neste sÃ¡bado teremos estudo sobre missÃµes urbanas.	2026-06-02 16:13:16.385349+00
99999999-0000-0000-0000-000000000002	66666666-0000-0000-0000-000000000001	00000000-0000-0000-0000-00000000b001	Lembrem-se de convidar um amigo para o encontro da prÃ³xima semana.	2026-06-04 16:13:16.385349+00
99999999-0000-0000-0000-000000000003	66666666-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	Casais Ãgape: nosso prÃ³ximo encontro serÃ¡ sobre EfÃ©sios 5. Tragam o caderno de anotaÃ§Ãµes.	2026-06-03 16:13:16.385349+00
99999999-0000-0000-0000-000000000004	66666666-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	Oremos juntos pelas famÃ­lias da congregaÃ§Ã£o que estÃ£o passando por desafios.	2026-06-05 04:13:16.385349+00
...
66666666-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	Jovens Resgate	Grupo de jovens com idades entre 15 e 30 anos. ReuniÃµes aos sÃ¡bados Ã s 19h no SalÃ£o dos Jovens. LÃ­der: Paulo Henrique Costa. Foco em evangelismo, discipulado e missÃµes urbanas.	\N	22222222-0000-0000-0000-000000000005	\N	\N	\N	t	\N	2026-06-04 19:03:23.834365+00	2026-06-05 15:46:00.21485+00
66666666-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	Casais Ãgape	Grupo para casais em todas as fases do casamento. ReuniÃµes quinzenais Ã s sextas-feiras Ã s 20h. CoordenaÃ§Ã£o: Ricardo e Juliana Pereira. Estudo atual: "Amor e Respeito" (Ef 5:22-33).	\N	22222222-0000-0000-0000-000000000007	\N	\N	\N	t	\N	2026-06-04 19:03:23.834365+00	2026-06-05 15:46:00.21485+00
...
dd00000b-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Jovens Resgate	Grupo jovens 15-30 anos. Evangelismo, discipulado e missÃµes.	jovens	dd000003-0000-0000-0000-000000000015	SalÃ£o dos Jovens	SÃ¡bado	19:00	t	\N	2026-06-15 21:46:45.369813+00	2026-06-15 21:46:45.369813+00
dd00000b-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	Casais Ãgape	Grupo casais. Estudo: Amor e Respeito (Ef 5:22-33).	casais	dd000003-0000-0000-0000-000000000002	SalÃ£o Paroquial	Sexta-feira	20:00	t	\N	2026-06-15 21:46:45.369813+00	2026-06-15 21:46:45.369813+00
dd00000b-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	Mulheres de FÃ©	Grupo mulheres â€” comunhÃ£o, oraÃ§Ã£o e estudo bÃ­blico.	mulheres	dd000003-0000-0000-0000-000000000007	SalÃ£o Paroquial	TerÃ§a-feira	14:00	t	\N	2026-06-15 21:46:45.369813+00	2026-06-15 21:46:45.369813+00
dd00000b-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	Homens de Valor	Grupo homens â€” lideranÃ§a familiar e espiritual.	homens	dd000003-0000-0000-0000-000000000005	Sala de Ensino	SÃ¡bado	08:00	t	\N	2026-06-15 21:46:45.369813+00	2026-06-15 21:46:45.369813+00
dd00000b-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	Adolescentes Raiz	Grupo adolescentes 12-17 anos. Atividades lÃºdicas e bÃ­blicas.	adolescentes	dd000003-0000-0000-0000-000000000008	SalÃ£o dos Jovens	SÃ¡bado	15:00	t	\N	2026-06-15 21:46:45.369813+00	2026-06-15 21:46:45.369813+00
\.
...
dd000014-0001-0000-0000-000000000001	dd000014-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	\N	secretary	Favor conferir o cadastro do irmÃ£o Marcos antes da emissÃ£o da carta.	text	\N	2026-06-09 23:04:53.704+00	\N
dd000014-0001-0000-0000-000000000002	dd000014-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	\N	admin	Verificado. Cadastro estÃ¡ completo e atualizado.	text	\N	2026-06-10 00:04:53.704+00	\N
dd000014-0001-0000-0000-000000000003	dd000014-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	\N	secretary	ReuniÃ£o de obreiros confirmada para quinta-feira Ã s 19h.	text	\N	2026-06-10 23:04:53.704+00	\N
dd000014-0001-0000-0000-000000000004	dd000014-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	\N	\N	treasurer	Tesouraria solicitou conferÃªncia do relatÃ³rio mensal.	text	\N	2026-06-11 23:04:53.704+00	\N
dd000014-0001-0000-0000-000000000005	dd000014-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	\N	\N	secretary	RelatÃ³rio enviado. Total de entradas: R$ 54.000 / SaÃ­das: R$ 23.620.	text	\N	2026-06-12 01:04:53.704+00	\N
...
dd000014-0001-0000-0000-000000000007	dd000014-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	\N	secretary	Carta de recomendaÃ§Ã£o da irmÃ£ Fernanda jÃ¡ foi aprovada.	text	\N	2026-06-13 23:04:53.704+00	\N
dd000014-0001-0000-0000-000000000008	dd000014-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	\N	pastor	Ã“timo. JÃ¡ assinei digitalmente. Pode enviar ao destinatÃ¡rio.	text	\N	2026-06-13 23:34:53.704+00	\N
dd000014-0001-0000-0000-000000000009	dd000014-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	\N	secretary	Pendente: carta para o irmÃ£o Rodrigo Maran. Aguardando documentaÃ§Ã£o.	text	\N	2026-06-14 23:04:53.704+00	\N
dd000014-0001-0000-0000-00000000000a	dd000014-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	\N	\N	secretary	Documento de atualizaÃ§Ã£o cadastral recebido pela secretaria.	text	\N	2026-06-06 23:04:53.704+00	\N
dd000014-0001-0000-0000-00000000000b	dd000014-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	\N	\N	admin	Processar e arquivar. Qualquer divergÃªncia, retornar ao membro.	text	\N	2026-06-07 23:04:53.704+00	\N
dd000014-0001-0000-0000-00000000000c	dd000014-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	\N	\N	secretary	ConcluÃ­do. Todos os cadastros atualizados e arquivados.	text	\N	2026-06-08 23:04:53.704+00	\N
...
8576eb91-a882-4099-9428-f364b830f2a1	668e26da-7fcc-4df1-9dd9-7eeb66daf964	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	\N	church_admin	Pas do Senhor meu IrmÃ£o	text	\N	2026-06-16 19:29:02.642125+00	\N
...
6407695c-2741-4a89-920d-ca73e99e29a4	edbf3b0d-c831-4566-b795-fd22984a4c7c	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	\N	church_admin	Paz do Senhor meu IrmÃ£o	text	\N	2026-06-17 11:43:35.342561+00	\N
...
190dd8eb-f938-47c7-b8dc-bc64532ad5bc	09b82cdb-14e4-4783-8328-6b19223e998c	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	\N	church_admin	Paz do Senhor IrmÃ£o Edson	text	\N	2026-06-17 14:29:19.806951+00	\N
210a0f19-27a5-481d-ac8e-b9160738d1ec	09b82cdb-14e4-4783-8328-6b19223e998c	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	\N	church_admin	Essa mensagem Ã© uma mensagem de teste do chat da secretaria com membros cadastrados e ativos no nosso sistema.	text	\N	2026-06-17 14:30:22.594603+00	\N
...
b8cd9e72-e7fa-4c27-b5ed-627c2de6ab26	a2d3fc9f-ed98-4af7-a2f1-46710226e9aa	10000000-0000-0000-0000-000000000002	129a8a20-1e51-4025-9d05-1516e48b188a	\N	admin	ðŸ“¹ ReuniÃ£o "Diretoria" criada. Use os botÃµes de ligaÃ§Ã£o/vÃ­deo para entrar na sala.	text	\N	2026-06-18 03:04:54.648677+00	\N
...
dd000014-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	\N	\N	\N	Cartas de RecomendaÃ§Ã£o	answered	secretariat	t	2026-06-16 19:27:44.543547+00	\N	2026-06-12 23:04:52.691+00	2026-06-16 19:27:44.543547+00
...
22222222-0000-0000-0000-000000000015	11111111-0000-0000-0000-000000000004	Marcos VinÃ­cius Rocha	Obreiro	Inativo	\N	\N	\N	Caxias do Sul	RS	\N	\N	\N	2021-11-08	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
...
22222222-0000-0000-0000-000000000013	11111111-0000-0000-0000-000000000004	AndrÃ© LuÃ­s Nascimento	DiÃ¡cono	Ativo	(54) 99999-0013	\N	\N	Caxias do Sul	RS	\N	\N	\N	2020-08-05	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
22222222-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	Pr. JoÃ£o Paulo Ferreira	Pastor	Ativo	(54) 99999-0001	pastor@adcaxias.org.br	\N	Caxias do Sul	RS	\N	\N	\N	2015-03-15	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
...
22222222-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	Carlos Roberto Lima	DiÃ¡cono	Ativo	(54) 99999-0003	carlos.lima@adcaxias.org.br	\N	Caxias do Sul	RS	\N	\N	\N	2017-01-10	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
...
22222222-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000004	Paulo Henrique Costa	LÃ­der de Jovens	Ativo	(54) 99999-0005	paulo.costa@adcaxias.org.br	\N	Caxias do Sul	RS	\N	\N	\N	2019-03-22	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
22222222-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000004	Fernanda Maria Alves	SecretÃ¡ria	Ativo	(54) 99999-0006	fernanda@adcaxias.org.br	\N	Caxias do Sul	RS	\N	\N	\N	2019-11-14	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
22222222-0000-0000-0000-000000000007	11111111-0000-0000-0000-000000000004	Ricardo JosÃ© Pereira	Tesoureiro	Ativo	(54) 99999-0007	tesoureiro@adcaxias.org.br	\N	Caxias do Sul	RS	\N	\N	\N	2020-02-28	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-05 19:06:54.40282+00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	Pendente	\N	\N	\N	\N	\N	\N	\N
...
ee000030-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	[STAGING] Carlos Teste	Membro	Ativo	(54) 99001-0000	staging.membro.1@ecclesia.test	Rua Staging 1, 10, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1950-01-01	1999-11-01	2000-03-01	[STAGING] Membro fictÃ­cio #1 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	001.050.100-01	\N	\N	\N	(54) 99001-0000	95010-001	Rua Staging 1	10	\N	Centro	\N	\N	Pai de Carlos â€” STAGING	MÃ£e de Carlos â€” STAGING	\N	\N	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	1999-12-01	\N
ee000030-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	[STAGING] Maria Demo	Membro	Ativo	(54) 99002-0001	staging.membro.2@ecclesia.test	Rua Staging 2, 20, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1963-02-02	2000-11-02	2001-03-02	[STAGING] Membro fictÃ­cio #2 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	002.051.101-02	\N	\N	\N	(54) 99002-0001	95010-001	Rua Staging 2	20	\N	Centro	\N	\N	Pai de Maria â€” STAGING	MÃ£e de Maria â€” STAGING	CÃ´njuge de Maria â€” STAGING	\N	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	[STAGING] JoÃ£o Staging	Membro	Ativo	(54) 99003-0002	staging.membro.3@ecclesia.test	Rua Staging 3, 30, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1976-03-03	2001-11-03	2002-03-03	[STAGING] Membro fictÃ­cio #3 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	003.052.102-03	\N	\N	\N	(54) 99003-0002	95010-001	Rua Staging 3	30	\N	Centro	\N	\N	Pai de JoÃ£o â€” STAGING	MÃ£e de JoÃ£o â€” STAGING	CÃ´njuge de JoÃ£o â€” STAGING	\N	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	[STAGING] Juliana FictÃ­cio	Membro	Ativo	(54) 99004-0003	staging.membro.4@ecclesia.test	Rua Staging 4, 40, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1989-04-04	2002-11-04	2003-03-04	[STAGING] Membro fictÃ­cio #4 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	004.053.103-04	\N	\N	\N	(54) 99004-0003	95010-001	Rua Staging 4	40	\N	Centro	\N	\N	Pai de Juliana â€” STAGING	MÃ£e de Juliana â€” STAGING	\N	\N	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	2002-12-01	\N
ee000030-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	[STAGING] Paulo Simulado	Membro	Inativo	(54) 99005-0004	staging.membro.5@ecclesia.test	Rua Staging 5, 50, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1952-05-05	2003-11-05	2004-03-05	[STAGING] Membro fictÃ­cio #5 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	ViÃºvo(a)	005.054.104-05	\N	\N	\N	(54) 99005-0004	95010-001	Rua Staging 5	50	\N	Centro	\N	\N	Pai de Paulo â€” STAGING	MÃ£e de Paulo â€” STAGING	\N	\N	\N	\N	Rejeitado	\N	Documento apresentado estava ilegÃ­vel â€” solicitar reapresentaÃ§Ã£o.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	[STAGING] Camila Teste	Auxiliar	Visitante	(54) 99006-0005	staging.membro.6@ecclesia.test	Rua Staging 6, 60, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1965-06-06	2004-11-06	2005-03-06	[STAGING] Membro fictÃ­cio #6 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Solteiro(a)	006.055.105-06	\N	\N	\N	(54) 99006-0005	95010-001	Rua Staging 6	60	\N	Centro	\N	\N	Pai de Camila â€” STAGING	MÃ£e de Camila â€” STAGING	\N	\N	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2007-06-01
ee000030-0000-0000-0000-000000000007	10000000-0000-0000-0000-000000000002	[STAGING] Felipe Demo	DiÃ¡cono	Congregado	(54) 99007-0006	staging.membro.7@ecclesia.test	Rua Staging 7, 70, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1978-07-07	2005-11-07	2006-03-07	[STAGING] Membro fictÃ­cio #7 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	007.056.106-07	\N	\N	\N	(54) 99007-0006	95010-001	Rua Staging 7	70	\N	Centro	\N	\N	Pai de Felipe â€” STAGING	MÃ£e de Felipe â€” STAGING	CÃ´njuge de Felipe â€” STAGING	\N	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	2005-12-01	2008-06-01
ee000030-0000-0000-0000-000000000008	10000000-0000-0000-0000-000000000002	[STAGING] Aline Staging	PresbÃ­tero	Em disciplina	(54) 99008-0007	staging.membro.8@ecclesia.test	Rua Staging 8, 80, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1991-08-08	2006-11-08	2007-03-08	[STAGING] Membro fictÃ­cio #8 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	008.057.107-08	\N	\N	\N	(54) 99008-0007	95010-001	Rua Staging 8	80	\N	Centro	\N	\N	Pai de Aline â€” STAGING	MÃ£e de Aline â€” STAGING	CÃ´njuge de Aline â€” STAGING	\N	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	2009-06-01
ee000030-0000-0000-0000-000000000009	10000000-0000-0000-0000-000000000002	[STAGING] Rafael FictÃ­cio	Evangelista	Transferido	(54) 99009-0008	staging.membro.9@ecclesia.test	Rua Staging 9, 90, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1954-09-09	2007-11-09	2008-03-09	[STAGING] Membro fictÃ­cio #9 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	009.058.108-09	\N	\N	\N	(54) 99009-0008	95010-001	Rua Staging 9	90	\N	Centro	\N	\N	Pai de Rafael â€” STAGING	MÃ£e de Rafael â€” STAGING	\N	\N	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2010-06-01
ee000030-0000-0000-0000-000000000010	10000000-0000-0000-0000-000000000002	[STAGING] Tatiana Simulado	Pastor	Falecido	(54) 99010-0009	staging.membro.10@ecclesia.test	Rua Staging 10, 100, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1967-10-10	2008-11-10	2009-03-10	[STAGING] Membro fictÃ­cio #10 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	010.059.109-10	\N	\N	\N	(54) 99010-0009	95010-001	Rua Staging 10	100	\N	Centro	\N	\N	Pai de Tatiana â€” STAGING	MÃ£e de Tatiana â€” STAGING	\N	\N	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	2008-12-01	2011-06-01
ee000030-0000-0000-0000-000000000011	10000000-0000-0000-0000-000000000002	[STAGING] Eduardo Teste	Membro	Ativo	(54) 99011-0010	staging.membro.11@ecclesia.test	Rua Staging 11, 110, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1980-11-11	2009-11-11	2010-03-11	[STAGING] Membro fictÃ­cio #11 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	011.060.110-11	\N	\N	\N	(54) 99011-0010	95010-001	Rua Staging 11	110	\N	Centro	\N	\N	Pai de Eduardo â€” STAGING	MÃ£e de Eduardo â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000012	10000000-0000-0000-0000-000000000002	[STAGING] Bruna Demo	Membro	Ativo	(54) 99012-0011	staging.membro.12@ecclesia.test	Rua Staging 12, 120, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1993-12-12	2010-11-12	2011-03-12	[STAGING] Membro fictÃ­cio #12 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	012.061.111-12	\N	\N	\N	(54) 99012-0011	95010-001	Rua Staging 12	120	\N	Centro	\N	\N	Pai de Bruna â€” STAGING	MÃ£e de Bruna â€” STAGING	CÃ´njuge de Bruna â€” STAGING	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000013	10000000-0000-0000-0000-000000000002	[STAGING] Bruno Staging	Membro	Ativo	(54) 99013-0012	staging.membro.13@ecclesia.test	Rua Staging 13, 130, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1956-01-13	2011-11-13	2012-03-13	[STAGING] Membro fictÃ­cio #13 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	013.062.112-13	\N	\N	\N	(54) 99013-0012	95010-001	Rua Staging 13	130	\N	Centro	\N	\N	Pai de Bruno â€” STAGING	MÃ£e de Bruno â€” STAGING	CÃ´njuge de Bruno â€” STAGING	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	2011-12-01	\N
ee000030-0000-0000-0000-000000000014	10000000-0000-0000-0000-000000000002	[STAGING] Caroline FictÃ­cio	Membro	Ativo	(54) 99014-0013	staging.membro.14@ecclesia.test	Rua Staging 14, 140, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1969-02-14	2012-11-14	2013-03-14	[STAGING] Membro fictÃ­cio #14 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	014.063.113-14	\N	\N	\N	(54) 99014-0013	95010-001	Rua Staging 14	140	\N	Centro	\N	\N	Pai de Caroline â€” STAGING	MÃ£e de Caroline â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000015	10000000-0000-0000-0000-000000000002	[STAGING] Henrique Simulado	Membro	Inativo	(54) 99015-0014	staging.membro.15@ecclesia.test	Rua Staging 15, 150, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1982-03-15	2013-11-15	2014-03-15	[STAGING] Membro fictÃ­cio #15 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	ViÃºvo(a)	015.064.114-15	\N	\N	\N	(54) 99015-0014	95010-001	Rua Staging 15	150	\N	Centro	\N	SecretÃ¡rio	Pai de Henrique â€” STAGING	MÃ£e de Henrique â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	\N	Rejeitado	\N	Documento apresentado estava ilegÃ­vel â€” solicitar reapresentaÃ§Ã£o.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000016	10000000-0000-0000-0000-000000000002	[STAGING] NatÃ¡lia Teste	Auxiliar	Visitante	(54) 99016-0015	staging.membro.16@ecclesia.test	Rua Staging 16, 160, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1995-04-16	2014-11-16	2015-03-16	[STAGING] Membro fictÃ­cio #16 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Solteiro(a)	016.065.115-16	\N	\N	\N	(54) 99016-0015	95010-001	Rua Staging 16	160	\N	Centro	\N	\N	Pai de NatÃ¡lia â€” STAGING	MÃ£e de NatÃ¡lia â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	2014-12-01	2017-06-01
ee000030-0000-0000-0000-000000000017	10000000-0000-0000-0000-000000000002	[STAGING] Matheus Demo	DiÃ¡cono	Congregado	(54) 99017-0016	staging.membro.17@ecclesia.test	Rua Staging 17, 170, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1958-05-17	2015-11-17	2016-03-17	[STAGING] Membro fictÃ­cio #17 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	017.066.116-17	\N	\N	\N	(54) 99017-0016	95010-001	Rua Staging 17	170	\N	Centro	\N	\N	Pai de Matheus â€” STAGING	MÃ£e de Matheus â€” STAGING	CÃ´njuge de Matheus â€” STAGING	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	2018-06-01
ee000030-0000-0000-0000-000000000018	10000000-0000-0000-0000-000000000002	[STAGING] Mariana Staging	PresbÃ­tero	Em disciplina	(54) 99018-0017	staging.membro.18@ecclesia.test	Rua Staging 18, 180, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1971-06-18	2016-11-18	2017-03-18	[STAGING] Membro fictÃ­cio #18 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	018.067.117-18	\N	\N	\N	(54) 99018-0017	95010-001	Rua Staging 18	180	\N	Centro	\N	\N	Pai de Mariana â€” STAGING	MÃ£e de Mariana â€” STAGING	CÃ´njuge de Mariana â€” STAGING	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	2019-06-01
ee000030-0000-0000-0000-000000000032	10000000-0000-0000-0000-000000000002	[STAGING] Larissa Demo	Membro	Ativo	(54) 99032-0031	staging.membro.32@ecclesia.test	Rua Staging 32, 320, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1953-08-04	2005-11-04	2006-03-04	[STAGING] Membro fictÃ­cio #32 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	032.081.131-32	\N	\N	\N	(54) 99032-0031	95010-001	Rua Staging 32	320	\N	Bela Vista	\N	\N	Pai de Larissa â€” STAGING	MÃ£e de Larissa â€” STAGING	CÃ´njuge de Larissa â€” STAGING	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000019	10000000-0000-0000-0000-000000000002	[STAGING] Thiago FictÃ­cio	Evangelista	Transferido	(54) 99019-0018	staging.membro.19@ecclesia.test	Rua Staging 19, 190, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1984-07-19	2017-11-19	2018-03-19	[STAGING] Membro fictÃ­cio #19 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	019.068.118-19	\N	\N	\N	(54) 99019-0018	95010-001	Rua Staging 19	190	\N	Centro	\N	\N	Pai de Thiago â€” STAGING	MÃ£e de Thiago â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	2017-12-01	2020-06-01
ee000030-0000-0000-0000-000000000020	10000000-0000-0000-0000-000000000002	[STAGING] Isabela Simulado	Pastor	Falecido	(54) 99020-0019	staging.membro.20@ecclesia.test	Rua Staging 20, 200, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1997-08-20	2018-11-20	2019-03-20	[STAGING] Membro fictÃ­cio #20 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	020.069.119-20	\N	\N	\N	(54) 99020-0019	95010-001	Rua Staging 20	200	\N	Centro	\N	Tesoureiro	Pai de Isabela â€” STAGING	MÃ£e de Isabela â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	2021-06-01
ee000030-0000-0000-0000-000000000021	10000000-0000-0000-0000-000000000002	[STAGING] VinÃ­cius Teste	Membro	Ativo	(54) 99021-0020	staging.membro.21@ecclesia.test	Rua Staging 21, 210, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1960-09-21	2019-11-21	2020-03-21	[STAGING] Membro fictÃ­cio #21 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	021.070.120-21	\N	\N	\N	(54) 99021-0020	95010-001	Rua Staging 21	210	\N	Centro	\N	\N	Pai de VinÃ­cius â€” STAGING	MÃ£e de VinÃ­cius â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000022	10000000-0000-0000-0000-000000000002	[STAGING] Eliane Demo	Membro	Ativo	(54) 99022-0021	staging.membro.22@ecclesia.test	Rua Staging 22, 220, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1973-10-22	2020-11-22	2021-03-22	[STAGING] Membro fictÃ­cio #22 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	022.071.121-22	\N	\N	\N	(54) 99022-0021	95010-001	Rua Staging 22	220	\N	Centro	\N	\N	Pai de Eliane â€” STAGING	MÃ£e de Eliane â€” STAGING	CÃ´njuge de Eliane â€” STAGING	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	2020-12-01	\N
ee000030-0000-0000-0000-000000000023	10000000-0000-0000-0000-000000000002	[STAGING] Leandro Staging	Membro	Ativo	(54) 99023-0022	staging.membro.23@ecclesia.test	Rua Staging 23, 230, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1986-11-23	2021-11-23	2022-03-23	[STAGING] Membro fictÃ­cio #23 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	023.072.122-23	\N	\N	\N	(54) 99023-0022	95010-001	Rua Staging 23	230	\N	Centro	\N	\N	Pai de Leandro â€” STAGING	MÃ£e de Leandro â€” STAGING	CÃ´njuge de Leandro â€” STAGING	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000024	10000000-0000-0000-0000-000000000002	[STAGING] CÃ¡ssia FictÃ­cio	Membro	Ativo	(54) 99024-0023	staging.membro.24@ecclesia.test	Rua Staging 24, 240, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1999-12-24	2022-11-24	2023-03-24	[STAGING] Membro fictÃ­cio #24 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	024.073.123-24	\N	\N	\N	(54) 99024-0023	95010-001	Rua Staging 24	240	\N	Centro	\N	\N	Pai de CÃ¡ssia â€” STAGING	MÃ£e de CÃ¡ssia â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000025	10000000-0000-0000-0000-000000000002	[STAGING] FÃ¡bio Simulado	Membro	Inativo	(54) 99025-0024	staging.membro.25@ecclesia.test	Rua Staging 25, 250, Centro, Caxias do Sul, RS	Caxias do Sul	RS	\N	1962-01-25	2023-11-25	2024-03-25	[STAGING] Membro fictÃ­cio #25 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	ViÃºvo(a)	025.074.124-25	\N	\N	\N	(54) 99025-0024	95010-001	Rua Staging 25	250	\N	Centro	\N	\N	Pai de FÃ¡bio â€” STAGING	MÃ£e de FÃ¡bio â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	\N	Rejeitado	\N	Documento apresentado estava ilegÃ­vel â€” solicitar reapresentaÃ§Ã£o.	\N	\N	\N	2023-12-01	\N
ee000030-0000-0000-0000-000000000026	10000000-0000-0000-0000-000000000002	[STAGING] Ana Teste	Auxiliar	Visitante	(54) 99026-0025	staging.membro.26@ecclesia.test	Rua Staging 26, 260, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1975-02-26	1999-11-26	2000-03-26	[STAGING] Membro fictÃ­cio #26 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Solteiro(a)	026.075.125-26	\N	\N	\N	(54) 99026-0025	95010-001	Rua Staging 26	260	\N	Bela Vista	\N	\N	Pai de Ana â€” STAGING	MÃ£e de Ana â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2002-06-01
ee000030-0000-0000-0000-000000000027	10000000-0000-0000-0000-000000000002	[STAGING] Marcos Demo	DiÃ¡cono	Congregado	(54) 99027-0026	staging.membro.27@ecclesia.test	Rua Staging 27, 270, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1988-03-27	2000-11-27	2001-03-27	[STAGING] Membro fictÃ­cio #27 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	027.076.126-27	\N	\N	\N	(54) 99027-0026	95010-001	Rua Staging 27	270	\N	Bela Vista	\N	\N	Pai de Marcos â€” STAGING	MÃ£e de Marcos â€” STAGING	CÃ´njuge de Marcos â€” STAGING	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	2003-06-01
ee000030-0000-0000-0000-000000000028	10000000-0000-0000-0000-000000000002	[STAGING] Fernanda Staging	PresbÃ­tero	Em disciplina	(54) 99028-0027	staging.membro.28@ecclesia.test	Rua Staging 28, 280, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1951-04-28	2001-11-28	2002-03-28	[STAGING] Membro fictÃ­cio #28 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	028.077.127-28	\N	\N	\N	(54) 99028-0027	95010-001	Rua Staging 28	280	\N	Bela Vista	\N	\N	Pai de Fernanda â€” STAGING	MÃ£e de Fernanda â€” STAGING	CÃ´njuge de Fernanda â€” STAGING	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	2001-12-01	2004-06-01
ee000030-0000-0000-0000-000000000029	10000000-0000-0000-0000-000000000002	[STAGING] Pedro FictÃ­cio	Evangelista	Transferido	(54) 99029-0028	staging.membro.29@ecclesia.test	Rua Staging 29, 290, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1964-05-01	2002-11-01	2003-03-01	[STAGING] Membro fictÃ­cio #29 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	029.078.128-29	\N	\N	\N	(54) 99029-0028	95010-001	Rua Staging 29	290	\N	Bela Vista	\N	\N	Pai de Pedro â€” STAGING	MÃ£e de Pedro â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2005-06-01
ee000030-0000-0000-0000-000000000030	10000000-0000-0000-0000-000000000002	[STAGING] PatrÃ­cia Simulado	Pastor	Falecido	(54) 99030-0029	staging.membro.30@ecclesia.test	Rua Staging 30, 300, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1977-06-02	2003-11-02	2004-03-02	[STAGING] Membro fictÃ­cio #30 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	030.079.129-30	\N	\N	\N	(54) 99030-0029	95010-001	Rua Staging 30	300	\N	Bela Vista	\N	\N	Pai de PatrÃ­cia â€” STAGING	MÃ£e de PatrÃ­cia â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	\N	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	2006-06-01
ee000030-0000-0000-0000-000000000031	10000000-0000-0000-0000-000000000002	[STAGING] AndrÃ© Teste	Membro	Ativo	(54) 99031-0030	staging.membro.31@ecclesia.test	Rua Staging 31, 310, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1990-07-03	2004-11-03	2005-03-03	[STAGING] Membro fictÃ­cio #31 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	031.080.130-31	\N	\N	\N	(54) 99031-0030	95010-001	Rua Staging 31	310	\N	Bela Vista	\N	\N	Pai de AndrÃ© â€” STAGING	MÃ£e de AndrÃ© â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	2004-12-01	\N
ee000030-0000-0000-0000-000000000033	10000000-0000-0000-0000-000000000002	[STAGING] Lucas Staging	Membro	Ativo	(54) 99033-0032	staging.membro.33@ecclesia.test	Rua Staging 33, 330, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1966-09-05	2006-11-05	2007-03-05	[STAGING] Membro fictÃ­cio #33 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	033.082.132-33	\N	\N	\N	(54) 99033-0032	95010-001	Rua Staging 33	330	\N	Bela Vista	\N	\N	Pai de Lucas â€” STAGING	MÃ£e de Lucas â€” STAGING	CÃ´njuge de Lucas â€” STAGING	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000034	10000000-0000-0000-0000-000000000002	[STAGING] Renata FictÃ­cio	Membro	Ativo	(54) 99034-0033	staging.membro.34@ecclesia.test	Rua Staging 34, 340, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1979-10-06	2007-11-06	2008-03-06	[STAGING] Membro fictÃ­cio #34 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	034.083.133-34	\N	\N	\N	(54) 99034-0033	95010-001	Rua Staging 34	340	\N	Bela Vista	\N	\N	Pai de Renata â€” STAGING	MÃ£e de Renata â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	2007-12-01	\N
ee000030-0000-0000-0000-000000000035	10000000-0000-0000-0000-000000000002	[STAGING] Rodrigo Simulado	Membro	Inativo	(54) 99035-0034	staging.membro.35@ecclesia.test	Rua Staging 35, 350, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1992-11-07	2008-11-07	2009-03-07	[STAGING] Membro fictÃ­cio #35 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	ViÃºvo(a)	035.084.134-35	\N	\N	\N	(54) 99035-0034	95010-001	Rua Staging 35	350	\N	Bela Vista	\N	SecretÃ¡rio	Pai de Rodrigo â€” STAGING	MÃ£e de Rodrigo â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	\N	Rejeitado	\N	Documento apresentado estava ilegÃ­vel â€” solicitar reapresentaÃ§Ã£o.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000036	10000000-0000-0000-0000-000000000002	[STAGING] Vanessa Teste	Auxiliar	Visitante	(54) 99036-0035	staging.membro.36@ecclesia.test	Rua Staging 36, 360, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1955-12-08	2009-11-08	2010-03-08	[STAGING] Membro fictÃ­cio #36 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Solteiro(a)	036.085.135-36	\N	\N	\N	(54) 99036-0035	95010-001	Rua Staging 36	360	\N	Bela Vista	\N	\N	Pai de Vanessa â€” STAGING	MÃ£e de Vanessa â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2012-06-01
ee000030-0000-0000-0000-000000000037	10000000-0000-0000-0000-000000000002	[STAGING] Gustavo Demo	DiÃ¡cono	Congregado	(54) 99037-0036	staging.membro.37@ecclesia.test	Rua Staging 37, 370, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1968-01-09	2010-11-09	2011-03-09	[STAGING] Membro fictÃ­cio #37 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	037.086.136-37	\N	\N	\N	(54) 99037-0036	95010-001	Rua Staging 37	370	\N	Bela Vista	\N	\N	Pai de Gustavo â€” STAGING	MÃ£e de Gustavo â€” STAGING	CÃ´njuge de Gustavo â€” STAGING	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	2010-12-01	2013-06-01
ee000030-0000-0000-0000-000000000038	10000000-0000-0000-0000-000000000002	[STAGING] Amanda Staging	PresbÃ­tero	Em disciplina	(54) 99038-0037	staging.membro.38@ecclesia.test	Rua Staging 38, 380, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1981-02-10	2011-11-10	2012-03-10	[STAGING] Membro fictÃ­cio #38 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	038.087.137-38	\N	\N	\N	(54) 99038-0037	95010-001	Rua Staging 38	380	\N	Bela Vista	\N	\N	Pai de Amanda â€” STAGING	MÃ£e de Amanda â€” STAGING	CÃ´njuge de Amanda â€” STAGING	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	2014-06-01
ee000030-0000-0000-0000-000000000039	10000000-0000-0000-0000-000000000002	[STAGING] Daniel FictÃ­cio	Evangelista	Transferido	(54) 99039-0038	staging.membro.39@ecclesia.test	Rua Staging 39, 390, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1994-03-11	2012-11-11	2013-03-11	[STAGING] Membro fictÃ­cio #39 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	039.088.138-39	\N	\N	\N	(54) 99039-0038	95010-001	Rua Staging 39	390	\N	Bela Vista	\N	\N	Pai de Daniel â€” STAGING	MÃ£e de Daniel â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	2015-06-01
ee000030-0000-0000-0000-000000000040	10000000-0000-0000-0000-000000000002	[STAGING] Priscila Simulado	Pastor	Falecido	(54) 99040-0039	staging.membro.40@ecclesia.test	Rua Staging 40, 400, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1957-04-12	2013-11-12	2014-03-12	[STAGING] Membro fictÃ­cio #40 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	040.089.139-40	\N	\N	\N	(54) 99040-0039	95010-001	Rua Staging 40	400	\N	Bela Vista	\N	Tesoureiro	Pai de Priscila â€” STAGING	MÃ£e de Priscila â€” STAGING	\N	ee000010-0000-0000-0000-000000000001	ee000020-0000-0000-0000-000000000001	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	2013-12-01	2016-06-01
ee000030-0000-0000-0000-000000000041	10000000-0000-0000-0000-000000000002	[STAGING] Leonardo Teste	Membro	Ativo	(54) 99041-0040	staging.membro.41@ecclesia.test	Rua Staging 41, 410, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1970-05-13	2014-11-13	2015-03-13	[STAGING] Membro fictÃ­cio #41 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	041.090.140-41	\N	\N	\N	(54) 99041-0040	95010-001	Rua Staging 41	410	\N	Bela Vista	\N	\N	Pai de Leonardo â€” STAGING	MÃ£e de Leonardo â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000042	10000000-0000-0000-0000-000000000002	[STAGING] Daniela Demo	Membro	Ativo	(54) 99042-0041	staging.membro.42@ecclesia.test	Rua Staging 42, 420, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1983-06-14	2015-11-14	2016-03-14	[STAGING] Membro fictÃ­cio #42 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	042.091.141-42	\N	\N	\N	(54) 99042-0041	95010-001	Rua Staging 42	420	\N	Bela Vista	\N	\N	Pai de Daniela â€” STAGING	MÃ£e de Daniela â€” STAGING	CÃ´njuge de Daniela â€” STAGING	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000043	10000000-0000-0000-0000-000000000002	[STAGING] Gabriel Staging	Membro	Ativo	(54) 99043-0042	staging.membro.43@ecclesia.test	Rua Staging 43, 430, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1996-07-15	2016-11-15	2017-03-15	[STAGING] Membro fictÃ­cio #43 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	043.092.142-43	\N	\N	\N	(54) 99043-0042	95010-001	Rua Staging 43	430	\N	Bela Vista	\N	\N	Pai de Gabriel â€” STAGING	MÃ£e de Gabriel â€” STAGING	CÃ´njuge de Gabriel â€” STAGING	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	2016-12-01	\N
ee000030-0000-0000-0000-000000000044	10000000-0000-0000-0000-000000000002	[STAGING] LetÃ­cia FictÃ­cio	Membro	Ativo	(54) 99044-0043	staging.membro.44@ecclesia.test	Rua Staging 44, 440, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1959-08-16	2017-11-16	2018-03-16	[STAGING] Membro fictÃ­cio #44 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	044.093.143-44	\N	\N	\N	(54) 99044-0043	95010-001	Rua Staging 44	440	\N	Bela Vista	\N	\N	Pai de LetÃ­cia â€” STAGING	MÃ£e de LetÃ­cia â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000045	10000000-0000-0000-0000-000000000002	[STAGING] Diego Simulado	Membro	Inativo	(54) 99045-0044	staging.membro.45@ecclesia.test	Rua Staging 45, 450, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1972-09-17	2018-11-17	2019-03-17	[STAGING] Membro fictÃ­cio #45 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	ViÃºvo(a)	045.094.144-45	\N	\N	\N	(54) 99045-0044	95010-001	Rua Staging 45	450	\N	Bela Vista	\N	\N	Pai de Diego â€” STAGING	MÃ£e de Diego â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	\N	Rejeitado	\N	Documento apresentado estava ilegÃ­vel â€” solicitar reapresentaÃ§Ã£o.	\N	\N	\N	\N	\N
ee000030-0000-0000-0000-000000000046	10000000-0000-0000-0000-000000000002	[STAGING] Viviane Teste	Auxiliar	Visitante	(54) 99046-0045	staging.membro.46@ecclesia.test	Rua Staging 46, 460, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1985-10-18	2019-11-18	2020-03-18	[STAGING] Membro fictÃ­cio #46 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Solteiro(a)	046.095.145-46	\N	\N	\N	(54) 99046-0045	95010-001	Rua Staging 46	460	\N	Bela Vista	\N	\N	Pai de Viviane â€” STAGING	MÃ£e de Viviane â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	2019-12-01	2022-06-01
ee000030-0000-0000-0000-000000000047	10000000-0000-0000-0000-000000000002	[STAGING] Igor Demo	DiÃ¡cono	Congregado	(54) 99047-0046	staging.membro.47@ecclesia.test	Rua Staging 47, 470, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1998-11-19	2020-11-19	2021-03-19	[STAGING] Membro fictÃ­cio #47 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Casado(a)	047.096.146-47	\N	\N	\N	(54) 99047-0046	95010-001	Rua Staging 47	470	\N	Bela Vista	\N	\N	Pai de Igor â€” STAGING	MÃ£e de Igor â€” STAGING	CÃ´njuge de Igor â€” STAGING	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de casamento	Validado	\N	\N	\N	\N	\N	\N	2023-06-01
ee000030-0000-0000-0000-000000000048	10000000-0000-0000-0000-000000000002	[STAGING] Sandra Staging	PresbÃ­tero	Em disciplina	(54) 99048-0047	staging.membro.48@ecclesia.test	Rua Staging 48, 480, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1961-12-20	2021-11-20	2022-03-20	[STAGING] Membro fictÃ­cio #48 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Casado(a)	048.097.147-48	\N	\N	\N	(54) 99048-0047	95010-001	Rua Staging 48	480	\N	Bela Vista	\N	\N	Pai de Sandra â€” STAGING	MÃ£e de Sandra â€” STAGING	CÃ´njuge de Sandra â€” STAGING	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de casamento	Apresentado	\N	\N	\N	\N	\N	\N	2024-06-01
ee000030-0000-0000-0000-000000000049	10000000-0000-0000-0000-000000000002	[STAGING] Caio FictÃ­cio	Evangelista	Transferido	(54) 99049-0048	staging.membro.49@ecclesia.test	Rua Staging 49, 490, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1974-01-21	2022-11-21	2023-03-21	[STAGING] Membro fictÃ­cio #49 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Masculino	Solteiro(a)	049.098.148-49	\N	\N	\N	(54) 99049-0048	95010-001	Rua Staging 49	490	\N	Bela Vista	\N	\N	Pai de Caio â€” STAGING	MÃ£e de Caio â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de nascimento	Pendente	\N	DocumentaÃ§Ã£o civil pendente â€” aguardando apresentaÃ§Ã£o ao secretÃ¡rio.	\N	\N	\N	2022-12-01	2025-06-01
ee000030-0000-0000-0000-000000000050	10000000-0000-0000-0000-000000000002	[STAGING] Helena Simulado	Pastor	Falecido	(54) 99050-0049	staging.membro.50@ecclesia.test	Rua Staging 50, 500, Bela Vista, Caxias do Sul, RS	Caxias do Sul	RS	\N	1987-02-22	2023-11-22	2024-03-22	[STAGING] Membro fictÃ­cio #50 para testes. NÃ£o representa pessoa real.	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	2026-06-22 23:45:21.469007+00	2026-06-22 23:45:21.469007+00	\N	\N	Feminino	Divorciado(a)	050.099.149-50	\N	\N	\N	(54) 99050-0049	95010-001	Rua Staging 50	500	\N	Bela Vista	\N	\N	Pai de Helena â€” STAGING	MÃ£e de Helena â€” STAGING	\N	ee000010-0000-0000-0000-000000000002	ee000020-0000-0000-0000-000000000002	CertidÃ£o de divÃ³rcio	Validado	\N	\N	\N	\N	\N	\N	2026-06-01
\.
...
997cd049-f710-4391-afcf-7dd01c15de03	international_convention	national_convention	t	Internacional â†’ Nacional (ex: RestauraÃ§Ã£o Internacional â†’ AD Brasil)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
c124198f-f162-4606-a91e-1d6997462e19	international_convention	state_convention	t	Internacional â†’ Estadual (missÃµes em estados/provÃ­ncias)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
1bfb0c75-6e05-4cd0-bc3b-a47b95f72800	international_convention	convencao	t	Internacional â†’ ConvenÃ§Ã£o legada (compatibilidade)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
86a640e5-0519-4931-9380-242bb3781c5b	international_convention	matriz	t	Internacional â†’ Matriz direta (campo missionÃ¡rio simples)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
c9277955-1dbe-47d7-b540-161f4bed7192	international_convention	sede	t	Internacional â†’ Sede direta (escritÃ³rio regional)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
93f2f2ce-911a-4f28-9256-ee83d80c1d5a	national_convention	state_convention	t	Nacional â†’ ConvenÃ§Ã£o Estadual (ex: CGADB â†’ CIEPADERGS)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
8a6369a7-1076-46aa-b922-7a78bc5028ba	national_convention	convencao	t	Nacional â†’ ConvenÃ§Ã£o legada (compatibilidade)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
358e661a-5f49-4874-89fa-7c3e036e960d	national_convention	matriz	t	Nacional â†’ Matriz direta (sem convenÃ§Ã£o estadual formal)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
5378d771-6fd4-4eb0-a26a-7c16a5590ae0	national_convention	sede	t	Nacional â†’ Sede direta (sem convenÃ§Ã£o estadual formal)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
2cfd026e-cd89-4628-ac74-ede127663da3	state_convention	matriz	t	Estadual â†’ Matriz Municipal	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
41e18640-32e5-4de1-9fff-bf23fa6cbe5e	state_convention	sede	t	Estadual â†’ Sede	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
ac750f52-d2f2-49dd-975a-c02cb95d1748	convencao	matriz	t	ConvenÃ§Ã£o legada â†’ Matriz (compatibilidade)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
8fff19dc-a7da-4253-bdf5-e0dd82122419	convencao	sede	t	ConvenÃ§Ã£o legada â†’ Sede (compatibilidade)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
6557f2d7-cb37-4b1c-99dc-ec3b5a06799a	matriz	setor	t	Matriz â†’ Setor / Distrito	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
351fe35f-b5db-4d11-b910-4f38e28f9bfa	matriz	congregacao	t	Matriz â†’ CongregaÃ§Ã£o direta (sem setor)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
eb095481-20a4-4619-a1bf-685c077ca8f4	sede	setor	t	Sede â†’ Setor / Distrito	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
9af84920-528c-4f9e-af0f-ad75823ac85b	sede	congregacao	t	Sede â†’ CongregaÃ§Ã£o direta (sem setor)	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
7272149e-ade4-4a38-9d90-e5edec6bb41f	setor	congregacao	t	Setor â†’ CongregaÃ§Ã£o	2026-06-26 06:01:49.421822+00	2026-06-26 06:01:49.421822+00
\.
...
10000000-0000-0000-0000-000000000001	\N	ConvenÃ§Ã£o Estadual RS	convencao-estadual-rs	convencao	Porto Alegre	RS	BR	pt-BR	\N	\N	\N	t	2026-05-21 21:12:52.343663+00	2026-05-21 21:15:59.074614+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
...
11111111-0000-0000-0000-000000000001	\N	Assembleia de Deus â€” MinistÃ©rio RS	assembleia-deus-ministerio-rs	convencao	Porto Alegre	RS	BR	pt-BR	\N	\N	\N	t	2026-06-04 19:03:23.834365+00	2026-06-05 17:45:20.178428+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
...
11111111-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000003	CongregaÃ§Ã£o Jardim AmÃ©rica	congregacao-jardim-america	congregacao	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-04 19:03:23.834365+00	2026-06-05 17:45:20.178428+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
...
ee000010-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Setor Centro â€” STAGING	setor-centro-staging	setor	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
ee000010-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	Setor Norte â€” STAGING	setor-norte-staging	setor	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
ee000010-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	Setor Sul â€” STAGING	setor-sul-staging	setor	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
ee000020-0000-0000-0000-000000000001	ee000010-0000-0000-0000-000000000001	CongregaÃ§Ã£o Centro â€” STAGING	cong-centro-staging	congregacao	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
ee000020-0000-0000-0000-000000000002	ee000010-0000-0000-0000-000000000002	CongregaÃ§Ã£o Bela Vista â€” STAGING	cong-bela-vista-staging	congregacao	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
ee000020-0000-0000-0000-000000000003	ee000010-0000-0000-0000-000000000003	CongregaÃ§Ã£o Cruzeiro â€” STAGING	cong-cruzeiro-staging	congregacao	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-22 23:45:16.988795+00	2026-06-22 23:45:16.988795+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
11111111-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000001	Assembleia de Deus em Caxias do Sul	assembleia-deus-caxias-do-sul	matriz	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-06-04 19:03:23.834365+00	2026-06-23 19:03:31.324255+00	Ativa	Assembleia de Deus	convention_matriz_intermediate_local	ConvenÃ§Ã£o	ConvenÃ§Ãµes	Matriz Municipal	Matrizes Municipais	Distrito	Distritos	CongregaÃ§Ã£o	CongregaÃ§Ãµes	t	t	t	t	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
10000000-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000001	Matriz Municipal Caxias do Sul	matriz-caxias-do-sul	matriz	Caxias do Sul	RS	BR	pt-BR	\N	\N	\N	t	2026-05-21 21:12:52.343663+00	2026-06-23 19:12:17.802665+00	Ativa	Assembleia de Deus	convention_matriz_intermediate_local	ConvenÃ§Ã£o	ConvenÃ§Ãµes	Matriz Municipal	Matrizes Municipais	Distrito	Distritos	CongregaÃ§Ã£o	CongregaÃ§Ãµes	t	t	t	t	\N	\N	\N	\N	\N	\N	t	f	\N	\N	\N
c2364ea8-4057-453e-af72-d22ae6058b57	10000000-0000-0000-0000-000000000002	Assembleia de Deus Santa FÃ©	edson-goncalves-mqr1k9pc	setor	Caxias do Sul	RS	BR	pt-BR	dinhogoncalves987@gmail.com	54996842709	\N	t	2026-06-23 19:32:42.502714+00	2026-06-23 19:33:57.598556+00	Ativa	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	95080410	Rua Dom Arthur Kratz	121	templo 02	\N	ecclesiabr.online	t	f	\N	\N	\N
\.
...
2a46b19e-bd34-4523-ae19-a8b5884b46a7	AdministraÃ§Ã£o	administracao	Atendimento administrativo geral da plataforma Ecclesia.	t	10	shield	amber	{dashboard,conversas,suporte,auditoria}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
bd51d3a9-e62e-4996-be12-422646e28da5	Secretaria	secretaria	Suporte para membros, carteiras, cartas, documentos, solicitaÃ§Ãµes, agenda e rotinas administrativas da igreja.	t	20	clipboard-list	indigo	{secretaria,membros,carteira_membros,cartas_recomendacao,solicitacoes,documentos,comunicacao,agenda,escalas,pequenos_grupos,assembleia_geral}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
ca1b254d-d299-4350-879f-a446457bcf4f	Financeiro	financeiro	Suporte para financeiro, relatÃ³rios, contas, categorias, centros de custo e integraÃ§Ãµes financeiras.	t	30	wallet	blue	{financeiro,relatorios}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
9682522e-2315-49c7-884d-7c7ef98c1785	Culto & Louvor	culto_louvor	Suporte para culto, louvor, escalas, campanhas e operaÃ§Ã£o ligada aos cultos.	t	40	music	purple	{culto_louvor,escalas,campanhas}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
e3cf4cf6-56c5-42c4-b4cb-5358f72ccd37	TÃ©cnico	tecnico	Suporte tÃ©cnico, diagnÃ³stico, integraÃ§Ãµes, unidades locais, configuraÃ§Ã£o e auditoria tÃ©cnica.	t	50	settings	slate	{unidades_locais,configuracoes,auditoria,suporte}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
c233c708-4e55-4f83-bcf6-f47d8c3392be	ImplantaÃ§Ã£o	implantacao	Suporte para onboarding de igrejas, estrutura organizacional, acessos iniciais, membros e documentos.	t	60	rocket	emerald	{unidades_locais,gerenciador_acesso,secretaria,membros,documentos,solicitacoes}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
b0de04c7-b8d2-42d9-921a-6f0cf724869a	TV Digital	tv_digital	Suporte para TV Online, transmissÃ£o, mÃ­dia, culto online e operaÃ§Ã£o audiovisual.	t	70	tv	red	{tv_online,culto_louvor,midia,transmissao}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
15287f27-d7a0-4790-8de8-7d35c3ea2b5a	Comunidade	comunidade	Suporte para comunidade, comunicaÃ§Ã£o, membros, interaÃ§Ã£o e recursos sociais do Ecclesia.	t	80	users	cyan	{comunidade,comunicacao,membros}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
9a5c8d32-38d5-4f90-81b3-af9099278ed5	Marketplace	marketplace	Suporte para marketplace, parcerias, ofertas, comunidade e integraÃ§Ãµes comerciais futuras.	t	90	shopping-bag	orange	{marketplace,comunidade,financeiro}	2026-06-26 23:40:10.404542+00	2026-06-26 23:40:10.404542+00
\.
...
77777777-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	\N	ProvisÃ£o para famÃ­lia Souza â€” Caxias do Sul	O irmÃ£o Lucas Souza, membro da CongregaÃ§Ã£o Jardim AmÃ©rica em Caxias do Sul/RS, estÃ¡ desempregado hÃ¡ trÃªs meses. Intercedamos para que o Senhor abra portas de trabalho e fortaleÃ§a a fÃ© dessa famÃ­lia.	Ativo	f	\N	2026-06-04 19:03:23.834365+00	2026-06-05 20:39:11.708159+00
77777777-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	\N	IntercessÃ£o pelo Congresso de OraÃ§Ã£o e MissÃµes	Agradecemos as oraÃ§Ãµes pelo Congresso de OraÃ§Ã£o e MissÃµes da Assembleia de Deus em Caxias do Sul. O evento foi abenÃ§oado; mantemos gratidÃ£o e pedimos continuidade no chamado missionÃ¡rio da congregaÃ§Ã£o.	Respondido	f	\N	2026-06-04 19:03:23.834365+00	2026-06-05 20:39:11.708159+00
dd00000f-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	\N	Cura de Margarida Ferrari	Pedido pela irmÃ£ em tratamento de saÃºde. OraÃ§Ã£o por restauraÃ§Ã£o e paz.	Ativo	f	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
dd00000f-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	\N	Obras do Novo Templo	IntercessÃ£o para Deus guiar a construÃ§Ã£o do novo templo.	Ativo	f	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
dd00000f-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	\N	ProvisÃ£o para famÃ­lia Maran	Rodrigo Maran desempregado hÃ¡ 2 meses. OraÃ§Ã£o por provisÃ£o.	Ativo	f	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
dd00000f-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	\N	MissÃ£o Ãfrica â€” proteÃ§Ã£o	Equipe missionÃ¡ria em MoÃ§ambique: proteÃ§Ã£o e frutos evangelÃ­sticos.	Ativo	f	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
dd00000f-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	\N	ReconciliaÃ§Ã£o familiar Volpato	Pedido reservado de restauraÃ§Ã£o familiar.	Ativo	t	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
dd00000f-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	\N	Agradecimento â€” recuperaÃ§Ã£o Cominetto	Antonio Cominetto recebeu alta hospitalar. Deus Ã© fiel!	Respondido	f	\N	2026-06-15 21:46:50.006854+00	2026-06-15 21:46:50.006854+00
\.
...
cfd0de8e-34b6-44dd-9676-65a30773bfde	6a15e7f4-86c0-4f9c-b923-55faa0cbbd8e	JoÃ£o Sila	Membro	\N	dinhoroquete@gmail.com	\N	\N	2026-05-18 21:05:04.301669+00	2026-05-18 21:05:04.301669+00
...
7497b992-2d8a-48ad-b37a-0f1dcf0d2b88	afb253e4-4ce2-40cf-8fe5-6d87af7b4824	Admin Matriz â€” STAGING	Membro	\N	admin.matriz.staging@ecclesia.test	\N	\N	2026-06-22 23:45:17.940415+00	2026-06-22 23:45:17.940415+00
5ef26833-dc69-4bb2-b47b-95d706d8dd51	d1a700c8-df40-4f5e-8657-52ce6237fdb7	SecretÃ¡ria Geral â€” STAGING	Membro	\N	secretaria.geral.staging@ecclesia.test	\N	\N	2026-06-22 23:45:18.335589+00	2026-06-22 23:45:18.335589+00
09042d42-1997-47d3-a080-3f4d3ee2d5ad	ceca19f8-eb06-4f8b-8b6f-a511985498cb	Tesoureiro Geral â€” STAGING	Membro	\N	tesoureiro.geral.staging@ecclesia.test	\N	\N	2026-06-22 23:45:18.681365+00	2026-06-22 23:45:18.681365+00
a803e7b2-a9e1-434a-a723-d083ceaad097	2354ec77-5053-4263-8aba-88ad05aa01f0	Admin Setor Centro â€” STAGING	Membro	\N	admin.setor.centro.staging@ecclesia.test	\N	\N	2026-06-22 23:45:19.052868+00	2026-06-22 23:45:19.052868+00
7d19d87f-b8d4-433c-aa5b-5a2929f8a00f	930a166e-9120-4a32-9dab-16272a425d6b	SecretÃ¡rio Setor Centro â€” STAGING	Membro	\N	secretario.setor.centro.staging@ecclesia.test	\N	\N	2026-06-22 23:45:19.397029+00	2026-06-22 23:45:19.397029+00
efa9f5cd-fbbe-4cf2-a95c-d34604b31bda	ea1868ff-7a23-49bc-8f62-c07d41833397	Admin CongregaÃ§Ã£o Centro â€” STAGING	Membro	\N	admin.congregacao.centro.staging@ecclesia.test	\N	\N	2026-06-22 23:45:19.739725+00	2026-06-22 23:45:19.739725+00
913fadcb-21ba-4055-af37-aabd9a87e1ed	05c9bc33-7cb7-4415-b228-f36635d7c52e	SecretÃ¡rio CongregaÃ§Ã£o Centro â€” STAGING	Membro	\N	secretario.congregacao.centro.staging@ecclesia.test	\N	\N	2026-06-22 23:45:20.096253+00	2026-06-22 23:45:20.096253+00
becc723e-0681-4867-922f-eb6b0d064aa0	1eebd10a-e9b5-433b-9b50-b37996a10dbc	Porteiro Centro â€” STAGING	Membro	\N	porteiro.centro.staging@ecclesia.test	\N	\N	2026-06-22 23:45:20.437535+00	2026-06-22 23:45:20.437535+00
d456b275-b882-465d-923d-2dbcd9e0b5b0	19421aff-207e-4f42-8dfc-c454d18e8cd6	Membro Teste â€” STAGING	Membro	\N	membro.teste.staging@ecclesia.test	\N	\N	2026-06-22 23:45:20.791654+00	2026-06-22 23:45:20.791654+00
...
dd000004-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	dd000003-0000-0000-0000-000000000003	Marcos Antonio Rossato	marcos.rossato@adcaxias.org.br	Assembleia de Deus â€” Zona Norte	Porto Alegre	RS	TransferÃªncia de residÃªncia	Membro se muda em razÃ£o de novo emprego na capital.	requested	9bb3aa44-d250-4ad9-ae2d-e79bb44fb4b9	Matriz Municipal Caxias do Sul	2026-06-02 21:53:19.932+00	\N	\N	\N	\N	2026-06-15 20:51:51.75559+00	2026-06-16 21:53:21.336998+00
dd000004-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	dd000003-0000-0000-0000-000000000013	Rafael Casagrande	\N	Assembleia de Deus â€” Campo de SÃ£o Paulo	SÃ£o Paulo	SP	MudanÃ§a para fins de estudo	Membro ingressou em universidade federal. Apresenta-se ao campo local.	requested	edf299cc-4c0f-45b9-80dd-8bca111bd0c9	Matriz Municipal Caxias do Sul	2026-06-09 21:53:19.932+00	\N	\N	\N	\N	2026-06-15 20:51:51.75559+00	2026-06-16 21:53:21.336998+00
dd000004-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	dd000003-0000-0000-0000-00000000000e	Simone Bettega	\N	Assembleia de Deus â€” BoqueirÃ£o â€” Curitiba	Curitiba	PR	ApresentaÃ§Ã£o de membro durante relocaÃ§Ã£o	RelocaÃ§Ã£o profissional de 6 meses. Membro em plena comunhÃ£o.	under_review	4084c79c-2c19-449a-a477-d08ab0952ff7	Matriz Municipal Caxias do Sul	2026-05-26 21:53:19.932+00	2026-05-29 21:53:19.932+00	\N	\N	\N	2026-06-15 20:51:51.75559+00	2026-06-16 21:53:21.336998+00
dd000004-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	dd000003-0000-0000-0000-000000000007	Fernanda Pasinato	fernanda.p@adcaxias.org.br	Assembleia de Deus â€” Campinas â€” FlorianÃ³polis	FlorianÃ³polis	SC	TransferÃªncia de congregaÃ§Ã£o	Membro em plena comunhÃ£o. TransferÃªncia solicitada pelo prÃ³prio membro.	approved	16c1cfdc-8e32-4319-9ecd-a223c3068f4e	Matriz Municipal Caxias do Sul	2026-05-17 21:53:19.932+00	2026-05-20 21:53:19.932+00	2026-05-22 21:53:19.932+00	\N	\N	2026-06-15 20:51:51.75559+00	2026-06-16 21:53:21.336998+00
dd000004-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	dd000003-0000-0000-0000-000000000009	Roberto Galvani	\N	Assembleia de Deus â€” Orlando â€” FL	Orlando	FL	Viagem missionÃ¡ria internacional	Membro viajou sem documentaÃ§Ã£o ministerial completa. Carta nÃ£o emitida.	rejected	c393cd2d-f1b2-4151-be2f-25c333dcf076	Matriz Municipal Caxias do Sul	2026-05-02 21:53:19.932+00	2026-05-05 21:53:19.932+00	\N	\N	\N	2026-06-15 20:51:51.75559+00	2026-06-16 21:53:21.336998+00
\.
...
77777777-0000-0000-0000-000000110005	77777777-0000-0000-0000-000000100002	22222222-0000-0000-0000-000000000002	RecepÃ§Ã£o	confirmado	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00
...
77777777-0000-0000-0000-000000110007	77777777-0000-0000-0000-000000100002	22222222-0000-0000-0000-000000000012	CafÃ©	pendente	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00
...
77777777-0000-0000-0000-000000110010	77777777-0000-0000-0000-000000100003	22222222-0000-0000-0000-000000000008	RecepÃ§Ã£o Kids	pendente	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00
...
77777777-0000-0000-0000-000000110012	77777777-0000-0000-0000-000000100004	22222222-0000-0000-0000-000000000009	ProjeÃ§Ã£o	recusado	Conflito de agenda	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00
77777777-0000-0000-0000-000000110013	77777777-0000-0000-0000-000000100004	22222222-0000-0000-0000-000000000004	TransmissÃ£o	pendente	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00
\.
...
77777777-0000-0000-0000-000000100001	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” Domingo ManhÃ£	Chegar 30 min antes para ensaio.	2026-05-24 13:00:00+00	Louvor	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00	publicada	10:00:00
77777777-0000-0000-0000-000000100003	11111111-0000-0000-0000-000000000004	EBD â€” MinistÃ©rio Infantil	Aguardando confirmaÃ§Ã£o de mais um auxiliar.	2026-05-24 13:00:00+00	Infantil	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00	rascunho	10:00:00
77777777-0000-0000-0000-000000100004	11111111-0000-0000-0000-000000000004	Culto de OraÃ§Ã£o â€” Quarta	TransmissÃ£o ao vivo no culto de oraÃ§Ã£o.	2026-05-27 22:30:00+00	MÃ­dia	\N	2026-06-05 16:55:27.366194+00	2026-06-05 16:55:27.366194+00	publicada	19:30:00
77777777-0000-0000-0000-000000100002	11111111-0000-0000-0000-000000000004	Culto de AdoraÃ§Ã£o â€” RecepÃ§Ã£o	Equipe de recepÃ§Ã£o e acolhimento no culto dominical.	2026-05-24 09:30:00+00	RecepÃ§Ã£o	\N	2026-06-05 16:55:27.366194+00	2026-06-05 17:09:20.374941+00	publicada	09:30:00
dd000010-0000-0000-0000-000000000001	10000000-0000-0000-0000-000000000002	Escala de Louvor 21/06	LÃ­der: Ana Paula Zanella. MÃºsicos: Gustavo Pegoraro, Vitor Andreatta.	2026-06-21 10:00:00+00	Louvor e AdoraÃ§Ã£o	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000002	10000000-0000-0000-0000-000000000002	Escala de RecepÃ§Ã£o 21/06	ResponsÃ¡veis: Leandro Basso e Cristiane Degasperi.	2026-06-21 09:30:00+00	RecepÃ§Ã£o e Acolhimento	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000003	10000000-0000-0000-0000-000000000002	Escala EBD 22/06	Infantil: Fernanda Pasinato. Jovens: Thiago Polesso. Adultos: Marcos.	2026-06-22 09:00:00+00	Escola BÃ­blica	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000004	10000000-0000-0000-0000-000000000002	Escala de IntercessÃ£o Junho	Equipe: Maria JosÃ© Tonetto, Simone Bettega, Elisangela Mantovani.	2026-06-01 00:00:00+00	IntercessÃ£o	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000005	10000000-0000-0000-0000-000000000002	Escala Santa Ceia 28/06	DiÃ¡conos: Leandro Basso, Paulo Antoniazzi. Apoio: Anderson Volpato.	2026-06-28 19:00:00+00	MinistÃ©rio	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000006	10000000-0000-0000-0000-000000000002	Escala de Louvor 28/06	LÃ­der: Ana Paula Zanella. MÃºsicos para Santa Ceia.	2026-06-28 19:00:00+00	Louvor e AdoraÃ§Ã£o	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
dd000010-0000-0000-0000-000000000007	10000000-0000-0000-0000-000000000002	Escala de Limpeza Semana	ResponsÃ¡veis: Camila Dallacosta e Antonio Cominetto.	2026-06-22 07:00:00+00	Administrativa	\N	2026-06-15 21:46:44.367557+00	2026-06-15 21:46:44.367557+00	publicada	\N
\.
...
88888888-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-04	DÃ­zimos â€” 1Âª semana de maio	Entrada	3250.00	Confirmado	Dizimos	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-04	Aluguel do Templo â€” maio/2026	Saida	2800.00	Pago	Administrativo	\N	\N	\N	\N	Banco	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-11	DÃ­zimos â€” 2Âª semana de maio	Entrada	2890.00	Confirmado	Dizimos	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-11	Energia ElÃ©trica â€” maio	Saida	480.00	Pago	Manutencao	\N	\N	\N	\N	Banco	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-11	Oferta de MissÃµes Nacionais	Entrada	850.00	Confirmado	Missoes	\N	\N	\N	\N	Especie	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-18	DÃ­zimos â€” 3Âª semana de maio	Entrada	3100.00	Confirmado	Dizimos	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000007	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-18	Material de Limpeza e ManutenÃ§Ã£o	Saida	145.00	Pago	Manutencao	\N	\N	\N	\N	Especie	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000008	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-18	Oferta Especial â€” Culto de Louvor	Entrada	620.00	Confirmado	Ofertas	\N	\N	\N	\N	Especie	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000009	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-04	HonorÃ¡rios Pastorais â€” maio	Saida	4000.00	Pago	Folha/Pastoral	\N	\N	\N	\N	Banco	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
88888888-0000-0000-0000-000000000010	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-11	Internet e Sistema â€” Ecclesia Admin	Saida	299.00	Pago	Administrativo	\N	\N	\N	\N	Banco	\N	\N	\N	\N	2026-06-04 19:03:23.834365+00	2026-06-04 19:03:23.834365+00	\N	manual
...
88888888-0000-0000-0000-000000000011	11111111-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	2026-05-10	Campanha â€” Reforma do Templo Central	Entrada	5000.00	Confirmado	Campanhas	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	aaaaaaaa-0000-0000-0000-000000000001	campaign
88888888-0000-0000-0000-000000000012	11111111-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	2026-05-12	Campanha â€” ConstruÃ§Ã£o SÃ£o JosÃ©	Entrada	8500.00	Confirmado	Campanhas	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	aaaaaaaa-0000-0000-0000-000000000002	campaign
88888888-0000-0000-0000-000000000013	11111111-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	2026-05-14	Campanha â€” MissÃµes Ãfrica	Entrada	3200.00	Confirmado	Campanhas	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	aaaaaaaa-0000-0000-0000-000000000003	campaign
88888888-0000-0000-0000-000000000014	11111111-0000-0000-0000-000000000004	00000000-0000-0000-0000-00000000b001	2026-05-08	Campanha â€” AÃ§Ã£o Social Inverno	Entrada	3500.00	Confirmado	Campanhas	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	aaaaaaaa-0000-0000-0000-000000000004	campaign
88888888-0000-0000-0000-000000000015	11111111-0000-0000-0000-000000000002	00000000-0000-0000-0000-00000000b001	2026-05-16	Campanha â€” Congresso de Jovens	Entrada	1200.00	Confirmado	Campanhas	\N	\N	\N	\N	PIX	\N	\N	\N	\N	2026-06-08 19:00:29.312695+00	2026-06-08 19:00:29.312695+00	aaaaaaaa-0000-0000-0000-000000000005	campaign
...
cccccccc-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	\N	Domingo ManhÃ£	2026-06-07	[{"id": "s1", "type": "abertura", "title": "Abertura", "content": "Bem-vindos ao culto de adoraÃ§Ã£o dominical."}, {"id": "s2", "type": "louvor", "title": "Sublime GraÃ§a", "songId": "bbbbbbbb-0000-0000-0000-000000000001", "content": ""}, {"id": "s3", "type": "louvor", "title": "Santo, Santo, Santo", "songId": "bbbbbbbb-0000-0000-0000-000000000002", "content": ""}, {"id": "s4", "type": "leitura", "title": "Leitura bÃ­blica", "content": "Salmos 100"}, {"id": "s5", "type": "mensagem", "title": "Mensagem", "content": "Tema: A graÃ§a que transforma"}, {"id": "s6", "type": "encerramento", "title": "Encerramento", "content": "Oremos e recebam a bÃªnÃ§Ã£o apostÃ³lica."}]	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
cccccccc-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	\N	Domingo Noite	2026-06-07	[{"id": "s1", "type": "abertura", "title": "Abertura", "content": "Culto da famÃ­lia â€” boa noite!"}, {"id": "s2", "type": "louvor", "title": "Grandioso Ã‰s Tu", "songId": "bbbbbbbb-0000-0000-0000-000000000003", "content": ""}, {"id": "s3", "type": "louvor", "title": "Em Cristo SÃ³", "songId": "bbbbbbbb-0000-0000-0000-000000000004", "content": ""}, {"id": "s4", "type": "oracao", "title": "OraÃ§Ã£o", "content": "Momento de intercessÃ£o pela famÃ­lia."}, {"id": "s5", "type": "mensagem", "title": "Mensagem", "content": "Tema: FamÃ­lias firmadas em Cristo"}, {"id": "s6", "type": "louvor", "title": "Teu Fiel Amor", "songId": "bbbbbbbb-0000-0000-0000-000000000005", "content": ""}, {"id": "s7", "type": "encerramento", "title": "Encerramento", "content": "BÃªnÃ§Ã£o e despedida."}]	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
cccccccc-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	\N	Santa Ceia	2026-06-14	[{"id": "s1", "type": "abertura", "title": "Abertura", "content": "CelebraÃ§Ã£o da Santa Ceia do Senhor."}, {"id": "s2", "type": "louvor", "title": "Bendito Seja o Deus de Amor", "songId": "bbbbbbbb-0000-0000-0000-000000000006", "content": ""}, {"id": "s3", "type": "leitura", "title": "Leitura bÃ­blica", "content": "1 CorÃ­ntios 11:23-26"}, {"id": "s4", "type": "oracao", "title": "OraÃ§Ã£o de preparaÃ§Ã£o", "content": "Momento de examinar o coraÃ§Ã£o."}, {"id": "s5", "type": "mensagem", "title": "MeditaÃ§Ã£o", "content": "O significado da Ceia"}, {"id": "s6", "type": "louvor", "title": "Cristo Meu Mestre", "songId": "bbbbbbbb-0000-0000-0000-000000000007", "content": ""}, {"id": "s7", "type": "encerramento", "title": "Encerramento", "content": "Partilhem o pÃ£o e o cÃ¡lice com reverÃªncia."}]	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
cccccccc-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	\N	Culto Jovem	2026-06-21	[{"id": "s1", "type": "abertura", "title": "Abertura", "content": "Culto dos jovens â€” sejam bem-vindos!"}, {"id": "s2", "type": "louvor", "title": "Canta Aleluia ao Senhor", "songId": "bbbbbbbb-0000-0000-0000-000000000008", "content": ""}, {"id": "s3", "type": "louvor", "title": "QuÃ£o Grande Ã‰s Tu", "songId": "bbbbbbbb-0000-0000-0000-000000000009", "content": ""}, {"id": "s4", "type": "louvor", "title": "Vindo a Cristo", "songId": "bbbbbbbb-0000-0000-0000-000000000010", "content": ""}, {"id": "s5", "type": "mensagem", "title": "Mensagem", "content": "Tema: Jovens que brilham no mundo"}, {"id": "s6", "type": "encerramento", "title": "Encerramento", "content": "OraÃ§Ã£o final e convite."}]	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
eceff8d0-c527-4ce6-ace5-c7d891c979a8	11111111-0000-0000-0000-000000000004	3a7e972d-f9d5-417a-984c-3652d6c2f28f	teste	2026-06-08	[{"id": "9f307852-1e4b-47fc-be30-35da7dee4e76", "type": "abertura", "title": "Aberturateste", "content": "efg"}, {"id": "a3f9b83d-4597-4881-8b25-3f906a6b1275", "type": "oracao", "title": "OraÃ§Ã£o", "content": "teste"}, {"id": "1a512f23-5574-4dc1-ace5-b862c4992c54", "type": "louvor", "title": "Teste", "songId": "68115882-8177-453f-9b32-98f8911d20bb", "content": "teste"}, {"id": "7d9b942f-dde9-459b-9fe6-7d20674d8c80", "type": "leitura", "title": "Leitura bÃ­blica", "content": "teste"}, {"id": "cf943e1b-9ab0-4eb9-be86-728796af0101", "type": "mensagem", "title": "Mensagem", "content": "teste"}, {"id": "99637b49-f15f-4ba2-8842-f1ca6d360128", "type": "encerramento", "title": "Encerramento", "content": "teste"}]	2026-06-04 20:38:09.908+00	2026-06-04 20:39:54.698746+00
\.
...
bbbbbbbb-0000-0000-0000-000000000001	11111111-0000-0000-0000-000000000004	\N	Sublime GraÃ§a	Sublime graÃ§a! QuÃ£o doce o som\nQue a um pecador como eu salvou!	G	Hino clÃ¡ssico	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
bbbbbbbb-0000-0000-0000-000000000002	11111111-0000-0000-0000-000000000004	\N	Santo, Santo, Santo	Santo, Santo, Santo!\nSenhor onipotente!	D	AdoraÃ§Ã£o	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
bbbbbbbb-0000-0000-0000-000000000003	11111111-0000-0000-0000-000000000004	\N	Grandioso Ã‰s Tu	Senhor, meu Deus, ao contemplar\nOs cÃ©us, o mar, a imensidÃ£o!	C	AdoraÃ§Ã£o	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
bbbbbbbb-0000-0000-0000-000000000004	11111111-0000-0000-0000-000000000004	\N	Em Cristo SÃ³	Em Cristo sÃ³ firmado estou,\nNÃ£o vacilo, pois nele confio!	A	ConfianÃ§a	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
bbbbbbbb-0000-0000-0000-000000000005	11111111-0000-0000-0000-000000000004	\N	Teu Fiel Amor	Teu fiel amor me guia neste vale escuro,\nNÃ£o temerei, pois estÃ¡s comigo!	E	Consolo	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
bbbbbbbb-0000-0000-0000-000000000006	11111111-0000-0000-0000-000000000004	\N	Bendito Seja o Deus de Amor	Bendito seja o Deus de amor,\nQue enviou seu Filho amado!	F	GratidÃ£o	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
...
bbbbbbbb-0000-0000-0000-000000000009	11111111-0000-0000-0000-000000000004	\N	QuÃ£o Grande Ã‰s Tu	Senhor, meu Deus, quando eu maravilhado\nContemplo toda a tua criaÃ§Ã£o!	D	AdoraÃ§Ã£o	\N	2026-06-04 19:03:25.657383+00	2026-06-04 19:03:25.657383+00
...
68115882-8177-453f-9b32-98f8911d20bb	11111111-0000-0000-0000-000000000004	3a7e972d-f9d5-417a-984c-3652d6c2f28f	Teste	teste	rÃ©	irmÃ£s	teste	2026-06-04 20:32:46.293+00	2026-06-04 20:32:44.525227+00
\.
...
COMMENT ON POLICY "organizations admins insert children" ON public.organizations IS 'Permite criaÃ§Ã£o de filhos estruturais por admins hierÃ¡rquicos (can_admin_organization).
   can_admin_organization Ã© recursiva â€” um admin nacional pode criar filhos estaduais/municipais.
   Platform admins tÃªm acesso irrestrito.
