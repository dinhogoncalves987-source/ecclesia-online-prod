...
const MODULE_ACCESS: Record<string, AppRole[]> = {
  ...
  "/admin/agenda": ["super_admin", "church_admin", "leader", "member"],
  "/admin/biblia": ["super_admin", "church_admin", "leader", "member"],
  "/admin/hinario": ["super_admin", "church_admin", "leader", "member"],
  "/admin/oracoes": ["super_admin", "church_admin", "leader", "member"],
  "/admin/comunicacao": ["super_admin", "church_admin", "pastor", "secretary", "leader", "member"],
  "/admin/grupos": ["super_admin", "church_admin", "leader"],
  "/admin/documentos": ["super_admin", "church_admin", "leader"],
  "/admin/relatorios": ["super_admin", "church_admin", "tesoureiro", "contador"],
  "/admin/assembleia-geral": ["super_admin", "church_admin", "leader", "member"],
  "/admin/escalas": ["super_admin", "church_admin", "leader", "member"],
