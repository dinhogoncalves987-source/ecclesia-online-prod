  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-3 px-4 py-24 text-center">
        ...
        <h1 className="font-serif text-xl font-semibold">Recurso indisponível</h1>
        <p className="max-w-md text-sm text-muted-foreground">
          Este recurso está disponível apenas no ambiente de teste e não faz parte da
          versão de gestão em produção.
        </p>
